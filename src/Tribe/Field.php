	...
	class Tribe__Events__Field {
		...
		public function doField() {
			...
			if ( $this->conditional ) {
				...
				if ( $this->display_callback && is_callable( $this->display_callback ) ) {
					...
					// fail, log the error
					Tribe__Events__Main::debug( esc_html__( 'Invalid field type specified', 'tribe-events-calendar' ), $this->type, 'notice' );
		...
		public function radio() {
			...
			if ( is_array( $this->options ) ) {
				...
				$field .= '<span class="tribe-error">' . esc_html__( 'No radio options specified', 'tribe-events-calendar' ) . '</span>';
			}
			$field .= $this->doFieldDivEnd();
			$field .= $this->doFieldEnd();
		...
		public function checkbox_list() {
			...
			if ( is_array( $this->options ) ) {
				...
				$field .= '<span class="tribe-error">' . esc_html__( 'No checkbox options specified', 'tribe-events-calendar' ) . '</span>';
			}
			$field .= $this->doFieldDivEnd();
			$field .= $this->doFieldEnd();
		...
		public function dropdown() {
			...
			if ( is_array( $this->options ) && ! empty( $this->options ) ) {
				...
				$field .= '<span class="tribe-error">' . esc_html__( 'No select options specified', 'tribe-events-calendar' ) . '</span>';
			}
			$field .= $this->doFieldDivEnd();
			$field .= $this->doFieldEnd();
