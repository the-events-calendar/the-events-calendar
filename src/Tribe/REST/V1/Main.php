...
class Tribe__Events__REST__V1__Main extends Tribe__REST__Main {
	...
	protected function register_documentation_endpoint() {
		...
		$documentation->register_definition_provider( 'ImageDetails', new Tribe__Events__REST__V1__Documentation__Image_Details_Definition_Provider() );
		$documentation->register_definition_provider( 'ImageSizeDetails', new Tribe__Events__REST__V1__Documentation__Image_Size_Details_Definition_Provider() );
		$documentation->register_definition_provider( 'DateDetails', new Tribe__Events__REST__V1__Documentation__Date_Details_Definition_Provider() );
		$documentation->register_definition_provider( 'CostDetails', new Tribe__Events__REST__V1__Documentation__Cost_Details_Definition_Provider() );
		$documentation->register_definition_provider( 'Term', new Tribe__Events__REST__V1__Documentation__Term_Definition_Provider() );
	}
