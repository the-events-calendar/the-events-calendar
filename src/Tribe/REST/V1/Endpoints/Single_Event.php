...
class Tribe__Events__REST__V1__Endpoints__Single_Event
	 ...
	 *
	 * @since 4.6
	 * @since TBD Added more logic to check if the user can delete the event.
	 *
	...
	public function can_delete( ?WP_REST_Request $request = null ) {
		...
		if ( ! $post_id ) {
			...
			preg_match( '/\/events\/(\d+)/', $request->get_route(), $matches );
	 ...
	 *
	 * @since 4.6
	 * @since TBD Added more logic to check if the user can edit the event.
	 *
	 * @param $request WP_REST_Request The request object.
	 *
