...
class Tribe__Events__REST__V1__EA_Messages extends Tribe__Events__REST__V1__Messages implements Tribe__REST__Messages_Interface {
	public function __construct() {
		...
		$ea_messages = array(
			'not-tec-rest-api-site'              => __( 'Event Aggregator cannot import events from this site; it could be running an outdated version of The Events Calendar or not use The Events Calendar at all.', 'the-events-calendar' ),
