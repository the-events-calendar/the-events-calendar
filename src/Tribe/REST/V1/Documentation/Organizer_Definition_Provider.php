	...
	public function get_documentation() {
		$documentation = array(
			...
			'properties' => array(
				...
				'link'                   => array( 'type' => 'string', 'description' => __( 'The URL to the organizer page', 'the-events-calendar' ) ),
				'title'                  => array( 'type' => 'string', 'description' => __( 'The organizer name', 'the-events-calendar' ) ),
				...
				'featured_image'         => array( 'type' => 'string', 'description' => __( 'The link to the full size organizer image if any', 'the-events-calendar' ) ),
				'featured_image_details' => array( 'type' => 'array', 'description' => __( 'An array listing the details of each version of the organizer image if any', 'the-events-calendar' ), '$ref' => '#/definitions/ImageDetails' ),
