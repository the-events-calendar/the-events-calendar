...
class Tribe__Events__REST__V1__Messages implements Tribe__REST__Messages_Interface {
	...
	public function __construct() {
		$this->messages = array(
			...
			'event-archive-bad-category'      => __( "The 'categories' parameter contained invalid category slugs or IDs", 'the-events-calendar' ),
			'event-archive-bad-tag'           => __( "The 'tags' parameter contained invalid tag slugs or IDs", 'the-events-calendar' ),
