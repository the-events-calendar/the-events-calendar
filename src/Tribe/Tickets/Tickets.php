	...
	abstract class Tribe__Events__Tickets__Tickets {
		...
		public final function ajax_handler_ticket_add() {
			...
			*/
			...
			if ( $return ) {
				...
				$return = $this->notice( esc_html__( 'Your ticket has been saved.', 'tribe-events-calendar' ) ) . $return;
		...
		public final function ajax_handler_ticket_delete() {
			...
			if ( $return ) {
				...
				$return = $this->notice( esc_html__( 'Your ticket has been deleted.', 'tribe-events-calendar' ) ) . $return;
