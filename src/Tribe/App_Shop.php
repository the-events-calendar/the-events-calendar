...
if ( ! class_exists( 'Tribe__Events__App_Shop' ) ) {
	...
	class Tribe__Events__App_Shop {
		...
		public function add_menu_page() {
			$page_title = esc_html__( 'Event Add-Ons', 'tribe-events-calendar' );
			$menu_title = esc_html__( 'Event Add-Ons', 'tribe-events-calendar' );
		...
		public function add_toolbar_item() {
			...
			if ( current_user_can( $capability ) ) {
				...
				$wp_admin_bar->add_menu( array(
					...
					'title'  => esc_html__( 'Event Add-Ons', 'tribe-events-calendar' ),
