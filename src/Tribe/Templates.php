...
if ( ! class_exists( 'Tribe__Events__Templates' ) ) {
	...
	class Tribe__Events__Templates extends Tribe__Templates {
		...
		public static function get_current_page_template() {
			...
			// short list view
			if ( tribe_is_shortlist_view() ) {
				$template = self::getTemplateHierarchy( 'shortlist', array( 'disable_view_check' => true ) );
			}
		...
		public static function get_current_template_class() {
			...
			// short list view
			elseif ( tribe_is_shortlist_view() || tribe_is_showing_all() || tribe_is_ajax_view_request( 'shortlist' ) ) {
				$class = 'Tribe__Events__Template__ShortList';
			}
			// month view
