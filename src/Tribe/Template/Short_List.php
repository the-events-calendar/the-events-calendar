...
if ( ! class_exists( 'Tribe__Events__Template__ShortList' ) ) {
	/**
	 * List view template class
	 */
	class Tribe__Events__Template__ShortList extends Tribe__Events__Template_Factory {
		...
		public function ajax_response() {
			...
			Tribe__Events__Main::instance()->displaying = apply_filters( 'tribe_events_listview_ajax_event_display', 'shortlist', $args );
