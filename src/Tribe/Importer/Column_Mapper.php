...
class Tribe__Events__Importer__Column_Mapper {
	...
	private function get_event_column_names() {
		return apply_filters( 'tribe_events_importer_event_column_names', array(
			...
			'event_category'          => esc_html__( 'Event Category', 'tribe-events-calendar' ),
			'event_website'           => esc_html__( 'Event Website', 'tribe-events-calendar' ),
			'event_tags'              => esc_html__( 'Event Tags', 'tribe-events-calendar' ),
			'event_currency_symbol'   => esc_html__( 'Event Currency Symbol', 'tribe-events-calendar' ),
			'event_currency_position' => esc_html__( 'Event Currency Position', 'tribe-events-calendar' ),
		) );
	}
