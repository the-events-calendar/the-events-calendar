...
class Tribe__Events__Plugin_Register extends Tribe__Abstract_Plugin_Register {
	...
	protected $dependencies = [
		'addon-dependencies' => [
			'Tribe__Events__Pro__Main'                 => '6.0.0-rc1-dev',
			'Tribe__Events__Filterbar__View'           => '5.5.0-rc1-dev',
			'Tribe__Events__Community__Main'           => '4.10.0-rc1-dev',
			'Tribe__Events__Community__Tickets__Main'  => '4.8.0-rc1-dev',
			// @todo @moraleida update the version below to the actual version of ET that will be released to support RBE
			'Tribe__Tickets__Main'                     => '5.6.0-rc1-dev',
