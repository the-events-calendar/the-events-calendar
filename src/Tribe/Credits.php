...
class Tribe__Events__Credits {
	...
	public function html_comment_credit( $after_html ) {
		$html_credit = "\n<!--\n" . esc_html__( 'This calendar is powered by The Events Calendar.', 'tribe-events-calendar' ) . "\nhttp://eventscalendarpro.com/\n-->\n";
