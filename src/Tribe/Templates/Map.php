	...
	class Tribe__Events__Pro__Templates__Map extends Tribe__Events__Pro__Template_Factory {
		...
		public function ajax_response() {
			...
			if ( $have_events && Tribe__Events__Pro__Geo_Loc::instance()->is_geoloc_query() ) {
				...
				Tribe__Notice::set_notice( 'events-not-found', sprintf( __( 'No matching events listed under %s. Please try viewing the full calendar for a complete list of events.', 'tribe-events-calendar' ), esc_html( $_POST['tribe_event_category'] ) ) );
			} elseif ( ! $have_events ) {
