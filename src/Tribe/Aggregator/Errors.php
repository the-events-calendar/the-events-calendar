...
class Tribe__Events__Aggregator__Errors {
	...
	private function __construct() {
		tribe_register_error( 'core:aggregator:invalid-record-object', __( 'The given Object or ID is not an existing Post', 'the-events-calendar' ) );
		tribe_register_error( 'core:aggregator:invalid-record-post_type', __( 'The given Post does not have the correct Type', 'the-events-calendar' ) );
