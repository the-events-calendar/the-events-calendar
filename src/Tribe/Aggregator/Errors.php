...
class Tribe__Events__Aggregator__Errors {
	...
	private function __construct() {
		...
		tribe_register_error( 'core:aggregator:invalid-json-response', __( 'There may be an issue with the Event Aggregator server. Please try your import again later.', 'the-events-calendar' ) );
