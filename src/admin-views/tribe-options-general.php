...
$generalTabFields = array(
	...
	'tribeEventsDisplayThemeTitle'  => array(
		'type' => 'html',
		'html' => '<h2>' . __( 'General Settings', 'tribe-events-calendar' ) . '</h2>',
	),
	'postsPerPage'                  => array(
		'type'            => 'text',
	...
	'tribeEventsDisplayTitle'       => array(
		'type' => 'html',
		'html' => '<h2>' . __( 'Map Settings', 'tribe-events-calendar' ) . '</h2>',
	),
	...
	'tribeEventsMiscellaneousTitle' => array(
		'type' => 'html',
		'html' => '<h2>' . __( 'Miscellaneous Settings', 'tribe-events-calendar' ) . '</h2>',
	),
