...
$generalTabFields = array(
	...
	'tribeEventsDisplayThemeTitle'  => array(
		'type' => 'html',
		'html' => '<h2>' . esc_html__( 'General Settings', 'tribe-events-calendar' ) . '</h2>',
	),
	'postsPerPage'                  => array(
		'type'            => 'text',
	...
	'tribeEventsDisplayTitle'       => array(
		'type' => 'html',
		'html' => '<h2>' . esc_html__( 'Map Settings', 'tribe-events-calendar' ) . '</h2>',
	),
	...
	'tribeEventsMiscellaneousTitle' => array(
		'type' => 'html',
		'html' => '<h2>' . esc_html__( 'Miscellaneous Settings', 'tribe-events-calendar' ) . '</h2>',
	),
