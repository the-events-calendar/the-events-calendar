...
<tr class="linked-post venue">
	...
	<td>
		<input tabindex="<?php tribe_events_tab_index(); ?>" type='text' name='venue[Address][]' size='25' value='<?php echo ( isset( $_VenueAddress ) ? esc_attr( $_VenueAddress ) : '' ); ?>' />
	</td>
</tr>
<tr class="linked-post venue">
	<td class='tribe-table-field-label'><?php esc_html_e( 'City:', 'the-events-calendar' ); ?></td>
	<td>
		<input tabindex="<?php tribe_events_tab_index(); ?>" type='text' name='venue[City][]' size='25' value='<?php echo ( isset( $_VenueCity ) ? esc_attr( $_VenueCity ) : '' ); ?>' />
	</td>
</tr>
<tr class="linked-post venue">
