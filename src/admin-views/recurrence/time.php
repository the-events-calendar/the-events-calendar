<div class="recurrence-row recurrence-time">
	...
	<span class="eventduration-preamble">
		<?php _ex( 'and will run for:', 'custom recurrence duration', 'tribe-events-calendar-pro' ); ?>
	</span>
	...
	<span class="eventduration">
		...
		<input type="number"
			...
			/>
		<?php _ex( 'days', 'custom recurrence duration', 'tribe-events-calendar-pro' ); ?>
		...
		<input type="number"
			...
			/>
		<?php _ex( 'hours', 'custom recurrence duration', 'tribe-events-calendar-pro' ); ?>
		...
		<input type="number"
			...
			/>
		<?php _ex( 'minutes', 'custom recurrence duration', 'tribe-events-calendar-pro' ); ?>
	</span>
</div>
