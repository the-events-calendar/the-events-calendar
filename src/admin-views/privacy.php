...
$suggested_text = $descr ? '<strong>' . esc_html__( 'Suggested text:', 'the-events-calendar' ) . ' </strong>' : '';

?>
<div class="tribe-events-privacy">
	<p><?php esc_html_e( 'Hello,', 'the-events-calendar' ); ?></p>
	<p><?php esc_html_e( 'This information serves as a guide on what sections need to be modified due to usage of The Events Calendar and its Add-ons.', 'the-events-calendar' ); ?></p>
	<p><?php esc_html_e( 'You should include the information below in the correct sections of you privacy policy.', 'the-events-calendar' ); ?></p>
	<p><strong> <?php esc_html_e( 'Disclaimer:', 'the-events-calendar' ); ?></strong> <?php esc_html_e( 'This information is only for guidance and not to be considered as legal advice.', 'the-events-calendar' ); ?></p>
	...
	<p><?php esc_html_e( 'The Events Calendar suite offers the use of third-party API keys. The primary functions are to enhance the features we\'ve built in, some of which use Google Maps, PayPal, Eventbrite, Meetup, and Facebook. These API keys are not supplied by Modern Tribe.', 'the-events-calendar' ); ?></p>

	<p><?php echo $suggested_text . esc_html__( 'We make use of certain API keys, in order to provide specific features.', 'the-events-calendar' ); ?></p>
	...
	<h3><?php esc_html_e( 'How Long You Retain this Data', 'the-events-calendar' ); ?></h3>

	<p><?php esc_html_e( 'All information (data) is retained in the local database indefinitely, unless otherwise deleted.', 'the-events-calendar' ); ?></p>
	...
	<h3><?php esc_html_e( 'Where We Send Your Data', 'the-events-calendar' ); ?></h3>

	<p><?php esc_html_e( 'Modern Tribe does not send any user data outside of your website by default.', 'the-events-calendar' ); ?></p>

	<p><?php esc_html_e( 'If you have extended our plugin(s) to send data to a third-party service such as Eventbrite, Google Maps, or PayPal, user information may be passed to these external services. These services may be located abroad.', 'the-events-calendar' ); ?></p>
