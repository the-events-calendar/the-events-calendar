...
if ( get_option( 'pue_install_key_event_aggregator' ) ) {
	...
	<fieldset id="tribe-field-facebook_token" class="tribe-field tribe-field-text tribe-size-medium">
		...
		<div class="tribe-field-wrap">
			...
			?>
			<br>
			<a target="_blank" style="line-height: 28px;" href="<?php echo esc_url( Tribe__Events__Aggregator__Record__Facebook::get_auth_url( array( 'back' => 'settings' ) ) ); ?>">Refresh your Facebook Token</a>
		</div>
	</fieldset>
