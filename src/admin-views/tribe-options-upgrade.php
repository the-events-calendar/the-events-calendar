	...
	if ( tribe_events_views_v2_is_enabled() ) {
		...
		<div id="tribe-upgrade-complete">
			...
			<div class="content-container">
				...
				<a class="button tec-settings-form__button" href="<?php echo esc_url( Tribe__Events__Main::instance()->getLink() ); ?>"><?php esc_html_e( 'View Calendar', 'the-events-calendar' ); ?></a>
			</div>
