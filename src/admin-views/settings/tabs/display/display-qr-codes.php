...
$tec_events_display_qr_codes = [
	...
	$slug['size']        => [
		...
		'default'         => '4',
		'options'         => [
			'4'  => esc_html__( '140x140', 'the-events-calendar' ),
			'8'  => esc_html__( '280x280', 'the-events-calendar' ),
			'12' => esc_html__( '420x420', 'the-events-calendar' ),
			'16' => esc_html__( '560x560', 'the-events-calendar' ),
			'20' => esc_html__( '700x700', 'the-events-calendar' ),
			'24' => esc_html__( '840x840', 'the-events-calendar' ),
			'28' => esc_html__( '980x980', 'the-events-calendar' ),
		],
