...
$tec_events_general_editing = [
	...
	'tec-aggregator-infobox-logo'               => [
		'type'        => 'html',
		'html'        => '<img class="tec-settings-infobox-logo" src="' . plugins_url( 'src/resources/images/settings-icons/icon-event-aggregator.svg', __DIR__ ) . '" alt="Events Aggregator Logo">',
		'conditional' => $is_missing_aggregator_license_key && ! $should_hide_upsell,
	],
