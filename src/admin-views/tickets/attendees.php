					...
					<td width="33%" valign="top">
						...
						foreach ( $tickets as $ticket ) {
							...
							if ( empty( $stock ) && $stock !== 0 ) {
								printf( esc_html__( 'Sold %1$d %2$s', 'tribe-events-calendar' ), esc_html( $sold ), $pending );
							}
							else {
								printf( esc_html__( 'Sold %1$d of %2$d %3$s', 'tribe-events-calendar' ), esc_html( $sold ), esc_html( $sold + $stock ), $pending );
							}
