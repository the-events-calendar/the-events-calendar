	 ...
	 */
		...
		'tribe_display_settings_tab_fields', array(
			...
			'info-box-title'                     => array(
				'type' => 'html',
				'html' => '<h1>' . esc_html__( 'Display Settings', 'tribe-events-calendar' ) . '</h1>',
			),
			...
			'tribeEventsBasicSettingsTitle'      => array(
				'type' => 'html',
				'html' => '<h2>' . esc_html__( 'Basic Template Settings', 'tribe-events-calendar' ) . '</h2>',
			),
			...
			'tribeEventsDateFormatSettingsTitle' => array(
				'type' => 'html',
				'html' => '<h2>' . esc_html__( 'Date Format Settings', 'tribe-events-calendar' ) . '</h2>',
			),
			...
			'tribeEventsAdvancedSettingsTitle'   => array(
				'type' => 'html',
				'html' => '<h2>' . esc_html__( 'Advanced Template Settings', 'tribe-events-calendar' ) . '</h2>',
			),
