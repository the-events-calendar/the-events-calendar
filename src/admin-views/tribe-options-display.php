	 ...
	 */
		...
		'tribe_display_settings_tab_fields', array(
			...
			'tribeEventsBasicSettingsTitle'      => array(
				'type' => 'html',
				'html' => '<h2>' . __( 'Basic Template Settings', 'tribe-events-calendar' ) . '</h2>',
			),
			...
			'tribeEventsDateFormatSettingsTitle' => array(
				'type' => 'html',
				'html' => '<h2>' . __( 'Date Format Settings', 'tribe-events-calendar' ) . '</h2>',
			),
			...
			'tribeEventsAdvancedSettingsTitle'   => array(
				'type' => 'html',
				'html' => '<h2>' . __( 'Advanced Template Settings', 'tribe-events-calendar' ) . '</h2>',
			),
