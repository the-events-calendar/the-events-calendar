...
<div class="tribe-row">
	...
	<div class="tribe-half-column">
		<h2><?php printf( esc_html__( 'Keep the Core Plugin %sFREE%s!', 'tribe-events-calendar' ), '<strong>', '</strong>' ); ?></h2>
		...
		<br/>
		<h2><?php esc_html_e( 'PSST... Want a Discount?', 'tribe-events-calendar' ); ?></h2>
