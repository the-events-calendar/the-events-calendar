...
<tr class="tribe-dependent" data-depends="#tribe-ea-field-meetup_import_type" data-condition="manual">
...
<tr class="tribe-dependent" data-depends="#tribe-ea-field-meetup_import_type" data-condition="schedule">
	<td colspan="2" class="tribe-button-row">
		<button type="submit" class="button button-primary">
			<?php
