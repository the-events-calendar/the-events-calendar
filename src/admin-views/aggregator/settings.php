...
if ( Tribe__Events__Aggregator::is_service_active() ) {
	$global = array(
		...
		'tribe_aggregator_default_import_limit_range' => array(
			...
			'tooltip' => esc_html__( 'When importing from an event source import events this far into the future; on slower websites this may impact the success of imports. Selecting a shorter time period may improve results.', 'the-events-calendar' ) . ' ' . sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_attr( 'https://theeventscalendar.com/knowledgebase/other-url-import-errors-in-event-aggregator' ), esc_html( 'Learn more.' ) ),
			'size' => 'medium',
			'validation_type' => 'options',
		...
		'tribe_aggregator_default_import_limit_number' => array(
			'type' => 'dropdown',
			'label' => esc_html__( 'Import numeric limit', 'the-events-calendar' ),
			// @todo set the KB link to the correct link
			'tooltip' => esc_html__( 'When importing from an event source import this many events; on slower websites this may impact the success of imports. Setting this to a smaller number may improve results.', 'the-events-calendar' ) . ' ' . sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_attr( 'https://theeventscalendar.com/knowledgebase/other-url-import-errors-in-event-aggregator' ), esc_html( 'Learn more.' ) ),
			'size' => 'medium',
			'validation_type' => 'options',
