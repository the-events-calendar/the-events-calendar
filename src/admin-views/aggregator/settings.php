...
$change_authority = [
	'import-defaults-update_authority'          => [
		'type'     => 'html',
		'html'     => '<h3 id="tribe-import-update-authority" class="tec_settings__section-header">' . esc_html__( 'Event Update Authority', 'the-events-calendar' ) . '</h3>',
		'priority' => 1.1,
	],
...
if ( Tribe__Events__Aggregator::is_service_active() ) {
	...
	$ical = [
		'ical-defaults' => [
			'type' => 'html',
			'html' => '<h3 id="tribe-import-ical-settings" class="tec_settings__section-header">' . esc_html__( 'iCalendar Import Settings', 'the-events-calendar' ) . '</h3>',
			'priority' => 20.1,
		],
	...
	$ics = [
		'ics-defaults' => [
			'type' => 'html',
			'html' => '<h3 id="tribe-import-ics-settings" class="tec_settings__section-header">' . esc_html__( 'ICS File Import Settings', 'the-events-calendar' ) . '</h3>',
			'priority'        => 25.1,
		],
	...
	$gcal = [
		'gcal-defaults' => [
			'type' => 'html',
			'html' => '<h3 id="tribe-import-google-settings" class="tec_settings__section-header">' . esc_html__( 'Google Calendar Import Settings', 'the-events-calendar' ) . '</h3>',
			'priority'  => 35.1,
		],
	...
	$meetup = [
		'meetup-defaults' => [
			'type' => 'html',
			'html' => '<h3 id="tribe-import-meetup-settings" class="tec_settings__section-header">' . esc_html__( 'Meetup Import Settings', 'the-events-calendar' ) . '</h3>',
			'priority' => 40.1,
		],
