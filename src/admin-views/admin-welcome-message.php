...
<p class="tribe-welcome-message"><?php printf( esc_html__( 'You are running Version %s and deserve a hug :-)', 'tribe-events-calendar' ), Tribe__Events__Main::VERSION ); ?></p>
...
<div class="tribe-row">
	<div class="tribe-half-column">
		<h2><?php esc_html_e( 'Keep The Events Calendar Core FREE', 'tribe-events-calendar' ); ?></h2>
		<p><?php esc_html_e( "5 star ratings help us bring TEC to more users. More happy users mean more support, more features, and more of everything you know and love about The Events Calendar. We couldn't do this without your support.", 'tribe-events-calendar' ); ?></p>
	...
	<div class="tribe-half-column">
		<h2><?php esc_html_e( 'Newsletter Signup', 'tribe-events-calendar' ); ?></h2>
