...
export const DEFAULT_STATE = {
	...
	naturalLanguage: '',
	dateTimeSeparator: settings() && settings().dateTimeSeparator ? settings().dateTimeSeparator : __( '@', 'the-events-calendar' ),
	timeRangeSeparator: settings() && settings().timeRangeSeparator ? settings().timeRangeSeparator : __( '-', 'the-events-calendar' ),
	allDay: false,
	multiDay: false,
