...
?>
<address class="tribe-events-calendar-day__event-venue">
	<span class="tribe-events-calendar-day__event-venue-title tribe-common-b2 tribe-common-b2--bold">
		<?php echo isset( $venue_details['linked_name'] ) ? esc_html( $venue_details['linked_name'] ) : esc_html__( 'Venue Name', 'the-events-calendar' ); ?>
	</span>
	<span class="tribe-events-calendar-day__event-venue-address tribe-common-b2">
