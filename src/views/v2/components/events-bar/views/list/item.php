 ...
 * @version TBD
 * @since 5.3.0
 * @since TBD Add aria-label to the view selector list item link.
 */
...
<li class="<?php echo esc_attr( implode( ' ', $list_item_classes ) ); ?>">
	<a
		...
		aria-label="<?php echo esc_html__( 'View events in ', 'the-events-calendar' ) . esc_html( $public_view_data->view_label ) . ' ' . esc_html__( 'View', 'the-events-calendar' ); ?>"
	>
