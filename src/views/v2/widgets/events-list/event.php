	...
	<div class="tribe-events-widget-events-list__event-wrapper tribe-common-g-col">
		<article <?php tribe_classes( $event_classes ) ?>>
			<div class="tribe-events-widget-events-list__event-details">
				...
				<?php $this->template( 'widgets/events-list/event/cost', [ 'event' => $event ] ); ?>
				<?php $this->template( 'widgets/events-list/event/venue', [ 'event' => $event ] ); ?>
				<?php $this->template( 'widgets/events-list/event/organizer', [ 'event' => $event ] ); ?>
