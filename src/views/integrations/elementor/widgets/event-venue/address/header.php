 ...
 * [your-theme]/tribe/events-pro/integrations/elementor/widgets/venue/event-venue/address/header.php
 *
 * @since TBD
 *
...
?>
<<?php echo tag_escape( $header_tag ); ?> <?php tribe_classes( $widget->get_address_base_class() . '-header' ); ?>>
