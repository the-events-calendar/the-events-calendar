...
if ( ! function_exists( 'tribe_events_timezone_choice' ) ) {
	...
	function tribe_events_timezone_choice( $selected_zone, $locale = null ) {
		/**
		 * Filters the HTML output for the timezone choices in the timezone picker.
		 *
		 * This filter allows customization of the HTML <option> elements used in the
		 * timezone picker. The default HTML is generated by the `wp_timezone_choice`
		 * function, which can be modified by attaching a custom function to this filter.
		 *
		 * @since 4.6.5
		 *
		 * @param string $html          The HTML output for the timezone choices.
		 * @param string $selected_zone The currently selected timezone.
		 * @param string $locale        The locale for the timezone choices.
		 *
		 * @return string The filtered HTML output for the timezone choices.
		 */
