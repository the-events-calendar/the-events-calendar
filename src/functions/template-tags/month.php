...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	...
	function tribe_show_month( $args = [], $template_path = 'month/content' ) {
		if ( tec_events_views_v1_should_display_deprecated_notice() ) {
			_deprecated_function( __FUNCTION__, 'TBD', 'Please refer to <a href="https://evnt.is/v1-removal">https://evnt.is/v1-removal</a> for template customization assistance.' );
		}
