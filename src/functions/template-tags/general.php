 ...
 */
	...
	function tribe_events_before_html() {
		...
		$before = $before . '<span class="tribe-events-ajax-loading"><img class="tribe-events-spinner-medium" src="' . tribe_resource_url( 'images/tribe-loading.gif' ) . '" alt="' . sprintf( __( 'Loading %s', 'the-events-calendar' ), $events_label_plural ) . '" /></span>';
