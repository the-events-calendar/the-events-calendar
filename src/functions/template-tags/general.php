...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	...
	function tribe_events_before_html() {
		...
		$before = $before . '<span class="tribe-events-ajax-loading"><img class="tribe-events-spinner-medium" src="' . esc_url( tribe_resource_url( 'images/tribe-loading.gif' ) ) . '" alt="' . sprintf( esc_html__( 'Loading %s', 'the-events-calendar' ), esc_attr( $events_label_plural ) ) . '" /></span>';
