...
if ( ! function_exists( 'tribe_get_the_day_link_label' ) ) {
	...
	function tribe_get_the_day_link_label( $date_description ) {
		switch ( strtolower( $date_description ) ) {
			case null :
				return esc_html__( 'Today', 'tribe-events-calendar' );
			case 'previous day' :
				return '<span>&laquo;</span> ' . esc_html__( 'Previous Day', 'tribe-events-calendar' );
			case 'next day' :
				return esc_html__( 'Next Day', 'tribe-events-calendar' ) . ' <span>&raquo;</span>';
			case 'yesterday' :
				return esc_html__( 'Yesterday', 'tribe-events-calendar' );
			case 'tomorrow' :
				return esc_html__( 'Tomorrow', 'tribe-events-calendar' );
			default :
