...
if ( class_exists( 'Tribe__Events__Advanced_Functions__Register_Meta' ) ) {
	...
	tribe_register_meta_group(
		'tribe_event_details', array(
			'label'   => esc_html__( 'Details', 'the-events-calendar' ),
			'classes' => array(
	...
	tribe_register_meta(
		'tribe_event_cost', array(
			...
			'label'        => esc_html__( 'Cost:', 'the-events-calendar' ),
			'priority'     => 20,
	...
	tribe_register_meta(
		'tribe_event_origin', array(
			...
			'label'           => esc_html__( 'Origin:', 'the-events-calendar' ),
	...
	tribe_register_meta(
		'tribe_event_title', array(
			...
			'label'    => sprintf( esc_html__( '%s:', 'the-events-calendar' ), tribe_get_event_label_singular() ),
