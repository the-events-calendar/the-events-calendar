...
if ( class_exists( 'Tribe__Events__Advanced_Functions__Register_Meta' ) ) {
	...
	tribe_register_meta_group(
		'tribe_event_details', array(
			'label'   => esc_html__( 'Details', 'tribe-events-calendar' ),
			'classes' => array(
	...
	tribe_register_meta(
		'tribe_event_cost', array(
			...
			'label'        => esc_html__( 'Cost:', 'tribe-events-calendar' ),
			'priority'     => 20,
	...
	tribe_register_meta(
		'tribe_event_tag', array(
			'label'           => esc_html__( 'Event Tags:', 'tribe-events-calendar' ),
	...
	tribe_register_meta(
		'tribe_event_website', array(
			...
			'label'           => esc_html__( 'Website:', 'tribe-events-calendar' ),
	...
	tribe_register_meta(
		'tribe_event_origin', array(
			...
			'label'           => esc_html__( 'Origin:', 'tribe-events-calendar' ),
	...
	tribe_register_meta_group(
		'tribe_event_venue', array(
			'label'   => esc_html__( 'Venue', 'tribe-events-calendar' ),
			'classes' => array(
	...
	tribe_register_meta(
		'tribe_event_venue_phone', array(
			...
			'label'    => esc_html__( 'Phone:', 'tribe-events-calendar' ),
			'priority' => 20,
	...
	tribe_register_meta(
		'tribe_event_venue_address', array(
			...
			'priority'        => 30,
			'label'           => esc_html__( 'Address:', 'tribe-events-calendar' ),
	...
	tribe_register_meta_group(
		'tribe_event_organizer', array(
			'label'   => esc_html__( 'Organizer', 'tribe-events-calendar' ),
			'classes' => array(
	...
	tribe_register_meta(
		'tribe_event_organizer_email', array(
			...
			'label'           => esc_html__( 'Email:', 'tribe-events-calendar' ),
			'priority'        => 30,
	...
	tribe_register_meta(
		'tribe_event_title', array(
			...
			'label'    => sprintf( esc_html__( '%s:', 'tribe-events-calendar' ), tribe_get_event_label_singular() ),
