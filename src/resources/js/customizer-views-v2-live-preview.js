...
( function ( $, api, obj ) {
	...
	obj.selectors = {
		...
		// Pro-added Control
		eventsBarViewSelectorBackgroundColorChoice:
			'tribe_customizer[tec_events_bar][view_selector_background_color_choice]',
	...
	obj.customProps = {
		/* Global Elements */
		globalFontFamily: [ '--tec-font-family-sans-serif', '--tec-font-family-base' ],
		globalFontSizeBase: [
			'--tec-font-size-0',
			'--tec-font-size-1',
			'--tec-font-size-2',
		...
		globalEventTitleColor: [ '--tec-color-text-events-title' ],
		globalEventDateColor: [ '--tec-color-text-event-date', '--tec-color-text-secondary-event-date' ],
		...
		globalLinkColor: [ '--tec-color-link-primary', '--tec-color-link-accent', '--tec-color-link-accent-hover' ],
		...
		eventsBarBackgroundColor: [ '--tec-color-background-events-bar', '--tec-color-background-events-bar-tabs' ],
		...
		monthDateMarkerColor: [ '--tec-color-day-marker-month', '--tec-color-day-marker-past-month' ],
	...
	// Font Size
	api( obj.selectors.globalFontSizeBase, function ( value ) {
		value.bind( function ( to ) {
			const fontSizeMultiplier = parseInt( to ) / 16;

			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.globalFontSizeBase.forEach( function ( fontSizeSelector, index ) {
	...
	// Event Title
	api( obj.selectors.globalEventTitleColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.globalEventTitleColor.forEach( function ( eventTitleSelector ) {
				...
				if ( 'default' === singleEventTitleColorChoice ) {
					obj.customProps.singleEventTitleColor.forEach( function ( eventTitleSelector ) {
						tribeElement.style.setProperty( eventTitleSelector, to );
					} );
				}
			} );
	...
	// Event Date
	api( obj.selectors.globalEventDateColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.globalEventDateColor.forEach( function ( eventDateSelector ) {
	...
	api( obj.selectors.globalBackgroundColorChoice, function ( value ) {
		value.bind( function ( to ) {
			const backgroundColor = 'transparent' !== to ? api( obj.selectors.globalBackgroundColor ).get() : to;
			...
			obj.root.forEach( function ( tribeElement ) {
				...
				if ( 'global_background' === eventsBarBackgroundColorChoice ) {
					const eventsBarBackgroundColor =
						'transparent' === to ? 'var(--tec-color-background)' : backgroundColor;

					const backgroundColorSelectors = obj.customProps.eventsBarBackgroundColor;

					backgroundColorSelectors.forEach( function ( colorSelector ) {
						tribeElement.style.setProperty( colorSelector, eventsBarBackgroundColor );
					} );

					const eventsBarViewSelectorBackgroundColorChoice = api(
	...
	// Accent Color
	api( obj.selectors.globalAccentColor, function ( value ) {
		value.bind( function ( to ) {
			const accentColor = to;
			const accentColorSelectors = obj.customProps.globalAccentColor;

			obj.root.forEach( function ( tribeElement ) {
				accentColorSelectors.forEach( function ( accentColorSelector ) {
				...
				if ( 'default' === eventsBarButtonColorChoice ) {
					...
					eventsBarButtonColor.forEach( function ( eventsBarButtonColorSelector ) {
				...
				if ( 'accent' === eventsBarIconColorChoice ) {
					...
					eventsBarIconColor.forEach( function ( eventsBarIconColorSelector ) {
	...
	// Link Color
	api( obj.selectors.globalLinkColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.globalLinkColor.forEach( function ( colorSelector ) {
					tribeElement.style.setProperty( colorSelector, to );
				} );
			} );
		} );
	...
	// Text Color
	api( obj.selectors.eventsBarTextColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.eventsBarTextColor.forEach( function ( colorSelector ) {
					tribeElement.style.setProperty( colorSelector, to );
				} );
	...
	// Button Text Color
	api( obj.selectors.eventsBarButtonTextColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.eventsBarButtonTextColor.forEach( function ( colorSelector ) {
					tribeElement.style.setProperty( colorSelector, to );
				} );
			} );
		} );
	...
	// Icon Color Choice
	api( obj.selectors.eventsBarIconColorChoice, function ( value ) {
		value.bind( function ( to ) {
			...
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.eventsBarIconColor.forEach( function ( colorSelector ) {
	...
	// Icon Color
	api( obj.selectors.eventsBarIconColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.eventsBarIconColor.forEach( function ( colorSelector ) {
					tribeElement.style.setProperty( colorSelector, to );
	...
	api( obj.selectors.eventsBarButtonColorChoice, function ( value ) {
		value.bind( function ( to ) {
			const buttonColor =
				'custom' === to
			...
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.eventsBarButtonColor.forEach( function ( colorSelector ) {
	...
	api( obj.selectors.eventsBarButtonColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.eventsBarButtonColor.forEach( function ( colorSelector ) {
					tribeElement.style.setProperty( colorSelector, to );
	...
	api( obj.selectors.eventsBarBackgroundColorChoice, function ( value ) {
		value.bind( function ( to ) {
			...
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.eventsBarBackgroundColor.forEach( function ( colorSelector ) {
	...
	api( obj.selectors.eventsBarBackgroundColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
				obj.customProps.eventsBarBackgroundColor.forEach( function ( colorSelector ) {
					tribeElement.style.setProperty( colorSelector, to );
	...
	api( obj.selectors.eventsBarViewSelectorBackgroundColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
	...
	api( obj.selectors.eventsBarBorderColorChoice, function ( value ) {
		value.bind( function ( to ) {
			const borderColor =
				'custom' === to ? api( obj.selectors.eventsBarBorderColor ).get() : 'var(--tec-color-border-secondary)';
	...
	api( obj.selectors.eventsBarBorderColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
	...
	// Days of Week Color
	api( obj.selectors.monthDaysOfWeekColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
	...
	// Date Marker Color
	api( obj.selectors.monthDateMarkerColor, function ( value ) {
		value.bind( function ( to ) {
			const monthDateMarkerColorSelectors = obj.customProps.monthDateMarkerColor;

			obj.root.forEach( function ( tribeElement ) {
				monthDateMarkerColorSelectors.forEach( function ( monthDateMarkerColorSelector ) {
	...
	api( obj.selectors.monthMultidayEventBarChoice, function ( value ) {
		value.bind( function ( to ) {
			const barColor =
				'custom' !== to
					? api( obj.selectors.globalAccentColor ).get()
	...
	// Multiday Bar Color
	api( obj.selectors.monthMultidayEventBarColor, function ( value ) {
		value.bind( function ( to ) {
	...
	// Grid Lines Color
	api( obj.selectors.monthGridLinesColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
	...
	// Grid Hover Color
	api( obj.selectors.monthGridHoverColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
	...
	api( obj.selectors.monthGridBackgroundColorChoice, function ( value ) {
		value.bind( function ( to ) {
			const backgroundColor =
				'custom' === to ? api( obj.selectors.monthGridBackgroundColor ).get() : 'transparent';
			const tooltipBackgroundColor = 'custom' === to ? '#fff' : api( obj.selectors.globalBackgroundColor ).get();
	...
	api( obj.selectors.monthGridBackgroundColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
	...
	api( obj.selectors.singleEventTitleColorChoice, function ( value ) {
		value.bind( function ( to ) {
	...
	api( obj.selectors.singleEventTitleColor, function ( value ) {
		value.bind( function ( to ) {
			obj.root.forEach( function ( tribeElement ) {
	 ...
	 *
	 * @return {Object} A custom RGB object.
	 */
	 ...
	 * @param {string} hex String representation of a hex color.
	 *
	 * @return {Object} An RGB string in the format 'r, g, b'.
	 */
