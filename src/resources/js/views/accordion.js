 ...
 * @type   {PlainObject}
 */
window.tribe.events.views.accordion = window.tribe.events.views.accordion || {};

/**
 * Initializes in a Strict env the code that manages the Event Views accordions.
 *
 * @since 4.9.4
 *
 * @param {PlainObject} $   jQuery
 * @param {PlainObject} obj window.tribe.events.views.accordion
 *
 * @return {void}
 */
( function ( $, obj ) {
	 ...
	 */
	obj.ready = function () {
		if ( ! window.tribe.events.views.manager ) {
	...
	$( obj.ready );
} )( jQuery, window.tribe.events.views.accordion );
