...
/**
 * Configures Date Picker Object in the Global Tribe variable
 *
 * @since TBD
 *
 * @type   {PlainObject}
...
( function( $, obj ) {
	...
	/**
	 * Handles the initialization of the date picker when Document is ready
	 *
	 * @since TBD
	 *
	 * @return {void}
