 ...
 * @type   {Object}
 */
window.tribe.events.views.breakpoints = window.tribe.events.views.breakpoints || {};
 ...
 * @param {Object}              obj window.tribe.events.views.breakpoints
 *
 * @return {void}
 */
( function ( $, obj ) {
	...
	$( obj.ready );
} )( jQuery, window.tribe.events.views.breakpoints );
