...
function createClassyElement(): HTMLElement {
    const classyElement = document.createElement('div');
    classyElement.id = 'tec-classy';
    classyElement.classList.add('classy-root', 'classy-root--admin');
