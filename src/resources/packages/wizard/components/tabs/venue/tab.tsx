...
const VenueContent = ( { moveToNextTab, skipToNextTab } ) => {
	...
	const subHeaderText =
		venueId > 0
			...
			: __(
					'Show your attendees where they need to go to get to your events. You can display the location using Google Maps on your event pages.',
					'the-events-calendar'
			  );
		...
		<>
			...
			<div className="tec-events-onboarding__tab-header">
				<h1 className="tec-events-onboarding__tab-heading">
					{ __( 'Add your first event venue', 'the-events-calendar' ) }
				</h1>
				...
				<div className="tec-events-onboarding__form-wrapper">
					...
					>
						...
						<span className="tec-events-onboarding__required-label">
							{ __( 'Venue name is required.', 'the-events-calendar' ) }
						</span>
					</BaseControl>
					<BaseControl
						__nextHasNoMarginBottom
					...
					>
						...
						/>
						<span className="tec-events-onboarding__required-label">
							{ __( 'Venue address is required.', 'the-events-calendar' ) }
						</span>
						<span className="tec-events-onboarding__invalid-label">
							{ __( 'Venue address is invalid.', 'the-events-calendar' ) }
						</span>
					</BaseControl>
					<BaseControl
						__nextHasNoMarginBottom
					...
					>
						...
						/>
						<span className="tec-events-onboarding__required-label">
							{ __( 'Venue city is required.', 'the-events-calendar' ) }
						</span>
						<span className="tec-events-onboarding__invalid-label">
							{ __( 'Venue city is invalid.', 'the-events-calendar' ) }
						</span>
					</BaseControl>
					<BaseControl
						__nextHasNoMarginBottom
					...
					>
						...
						/>
						<span className="tec-events-onboarding__required-label">
							{ __( 'Venue state is required.', 'the-events-calendar' ) }
						</span>
						<span className="tec-events-onboarding__invalid-label">
							{ __( 'Venue state is invalid.', 'the-events-calendar' ) }
						</span>
					</BaseControl>
					<BaseControl
						__nextHasNoMarginBottom
					...
					>
						...
						/>
						<span className="tec-events-onboarding__required-label">
							{ __( 'Venue zip/postal code is required.', 'the-events-calendar' ) }
						</span>
						<span className="tec-events-onboarding__invalid-label">
							{ __( 'Venue zip/postal code is invalid.', 'the-events-calendar' ) }
						</span>
					</BaseControl>
					<BaseControl
						__nextHasNoMarginBottom
					...
					<span className="tec-events-onboarding__invalid-label">
						{ __( 'Venue country is invalid.', 'the-events-calendar' ) }
					</span>
					{ ! venueId && showPhone ? (
						''
					) : (
						...
						>
							{ _x(
								'Add a phone +',
								'Direction to add an phone followed by a plus sign to indicate it shows a visually hidden field.',
								'the-events-calendar'
							) }
						</Button>
					) }
					...
					>
						...
						/>
						<span className="tec-events-onboarding__required-label">
							{ __( 'Venue phone is required.', 'the-events-calendar' ) }
						</span>
						<span className="tec-events-onboarding__invalid-label">
							{ __( 'Venue phone is invalid.', 'the-events-calendar' ) }
						</span>
					</BaseControl>
					{ ! venueId && showWebsite ? (
						''
						...
						>
							{ _x(
								'Add a website +',
								'Direction to add a website followed by a plus sign to indicate it shows a visually hidden field.',
								'the-events-calendar'
							) }
						</Button>
					) }
					...
					>
						...
						/>
						<span className="tec-events-onboarding__required-label">
							{ __( 'Venue website is required.', 'the-events-calendar' ) }
						</span>
						{ website && ! website.toLowerCase().startsWith( 'http' ) ? (
							<span className="tec-events-onboarding__invalid-label">
								{ __(
									'Venue website must start with a protocol, i.e. "https://"',
									'the-events-calendar'
								) }
							</span>
						) : (
