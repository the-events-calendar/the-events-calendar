...
const OrganizerContent = ( { moveToNextTab, skipToNextTab } ) => {
	...
	const [ organizerId ] = useState( organizer.organizerId || false );
	...
	const subHeaderText =
		organizerId > 0
			...
			: __(
					'Add an event organizer for your events. You can display this information for your event attendees on your website.',
					'the-events-calendar'
			  );
		...
		<>
			...
			<div className="tec-events-onboarding__tab-header">
				<h1 className="tec-events-onboarding__tab-heading">
					{ __( 'Add your first event organizer', 'the-events-calendar' ) }
				</h1>
				...
				<div className="tec-events-onboarding__form-wrapper">
					...
					>
						...
						<span className="tec-events-onboarding__required-label">
							{ __( 'Organizer name is required.', 'the-events-calendar' ) }
						</span>
					</BaseControl>
					{ ! organizerId && showPhone ? (
						...
						>
							{ _x(
								'Add a phone number +',
								'Direction to add a phone number followed by a plus sign to indicate it shows a visually hidden field.',
								'the-events-calendar'
							) }
						</Button>
					) }
					...
					>
						...
						/>
						<span className="tec-events-onboarding__required-label">
							{ __( 'Organizer phone is required.', 'the-events-calendar' ) }
						</span>
						<span className="tec-events-onboarding__invalid-label">
							{ __( 'Organizer phone is invalid.', 'the-events-calendar' ) }
						</span>
					</BaseControl>
					...
					>
						...
						/>
						<span className="tec-events-onboarding__required-label">
							{ __( 'Organizer website is required.', 'the-events-calendar' ) }
						</span>

						{ website && ! website.toLowerCase().startsWith( 'http' ) ? (
							<span className="tec-events-onboarding__invalid-label">
								{ __(
									'Organizer website must start with a protocol, i.e. "https://"',
									'the-events-calendar'
								) }
							</span>
						) : (
					...
					{ ! organizerId && showEmail ? (
						...
						>
							{ _x(
								'Add an email +',
								'Direction to add an email followed by a plus sign to indicate it shows a visually hidden field.',
								'the-events-calendar'
							) }
						</Button>
					) }
					...
					>
						...
						/>
						<span className="tec-events-onboarding__required-label">
							{ __( 'Organizer email is required.', 'the-events-calendar' ) }
						</span>
						<span className="tec-events-onboarding__invalid-label">
							{ __( 'Organizer email is invalid.', 'the-events-calendar' ) }
						</span>
					</BaseControl>
				</div>
