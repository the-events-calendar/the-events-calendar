...
const ViewCheckbox = ( { view, isChecked, onChange, icon } ) => {
	const viewLabel =
		view === 'all'
			? __( 'Select all the views', 'the-events-calendar' )
		...
		>
			...
			<div>
				<label
					...
					className={
						isChecked
							? 'tec-events-onboarding__checkbox-label tec-events-onboarding__checkbox-label--checked'
							: 'tec-events-onboarding__checkbox-label'
					}
				>
					{ icon }
					{ viewLabel }
