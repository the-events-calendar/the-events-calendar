...
class Organizers extends Post_Entity_Endpoint implements Readable_Endpoint {
	...
	public function read_args(): array {
		return [
			...
			'event'              => [
				'description'       => __( 'Limit result set to organizers with specific event.', 'the-events-calendar' ),
				'type'              => 'integer',
				'validate_callback' => [ $this->validator, 'is_positive_int' ],
			],
			'has_events'         => [
				'description' => __( 'Limit result set to organizers with events.', 'the-events-calendar' ),
				'type'        => 'boolean',
				'default'     => false,
			],
			'only_with_upcoming' => [
				'description' => __( 'Limit result set to organizers with upcoming events.', 'the-events-calendar' ),
				'type'        => 'boolean',
				'default'     => false,
			],
			'status'             => [
