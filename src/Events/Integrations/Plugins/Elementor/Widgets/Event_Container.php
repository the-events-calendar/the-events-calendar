<?php
/**
 * Event Container Elementor Widget.
 *
 * @since   TBD
 *
...
/**
 * Class Widget_Event_Container
 *
 * @since   TBD
 *
 * @package TEC\Events\Integrations\Plugins\Elementor\Widgets
 */
class Event_Container extends \Elementor\Includes\Elements\Container {
	 ...
	 * @param array|null $args Container arguments.
	 *
	 * @return void
	 */
	...
	public function get_title() {
		return esc_html__( 'Event Container', 'elementor' );
	}
	...
	public function get_keywords() {
		return [ 'Event', 'Container', 'Flex', 'Flexbox', 'Flexbox Container', 'Layout' ];
	}

	/**
	 * Get the element presets (none).
	 */
	...
	protected function render_shape_divider( $side ) {
		...
		<div
			...
			data-negative="<?php Utils::print_unescaped_internal_string( $negative ? 'true' : 'false' ); ?>">
			<?php
	...
	/**
	 * Check if the container is boxed.
	 *
	 ...
	 *
	 * @param bool $is_container_grid_active Whether the container grid experiment is active.
	 */
	...
	/**
	 * Get the Container's layout controls.
	 *
	 * @param bool $is_container_grid_active Whether the container grid experiment is active.
	 *
	 * @return array
	...
	/**
	 * Hook the sticky notice into the transform section.
	 *
	 * @return void
	 */
	protected function hook_sticky_notice_into_transform_section() {
		add_action(
			'elementor/element/container/_section_transform/after_section_start',
			function ( Event_Container $container ) {
