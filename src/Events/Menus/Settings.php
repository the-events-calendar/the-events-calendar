...
/**
 * Admin Settings menu/page for TEC plugins.
 *
 * @since TBD
 *
...
use TEC\Common\Menus\Traits\With_Settings;
 ...
 * @package TEC\Events\Menus
 */
class Settings extends Abstract_Menu {
	use With_Admin_Bar, With_Settings;
	...
	public function init() : void {
		...
		$this->menu_title   = _x( 'Event Settings', 'The title for the admin menu link', 'the-events-calendar');
		$this->page_title   = _x( 'Event Settings', 'The title for the admin page', 'the-events-calendar');
		$this->parent_file  = 'tec-events';
		$this->parent_slug  = 'tec-events';

		add_filter( 'wpsf_register_settings_tec', [$this, 'tec_tabless_settings' ] );
	}

	/** The following functions should be overridden, and are just here for examples */

	/**
	 * Tabless example.
	 *
	 * @param array $tec_settings Settings.
	 */
	function tec_tabless_settings( $tec_settings ) {
	 ...
	 * @param array $tec_settings settings.
	 */
	function tec_tabbed_settings( $tec_settings ) {
		// Tabs.
