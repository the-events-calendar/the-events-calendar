	<div id="tec-content" class="upcoming">
		...
		<span class='tec-calendar-buttons'> 
			<a class='tec-button-on' href='<?php echo sp_get_listview_link(); ?>'><?php _e('Event List', $tribe_ecp->pluginDomain)?></a>
			<a class='tec-button-off' href='<?php echo sp_get_gridview_link(); ?>'><?php _e('Calendar', $tribe_ecp->pluginDomain)?></a>
		</span>
		              ...
		              <table cellspacing="0">
		                  ...
		                  <tr>
							...
							<?php if( get_post_meta( $post->ID, '_EventShowMapLink', true ) == 'true' ) : ?>
								<a class="gmap" href="<?php sp_the_map_link(); ?>" title="Click to view a Google Map" target="_blank"><?php _e('Google Map', $tribe_ecp->pluginDomain ); ?></a>
							<?php endif; ?></td>
		...
		<div id="tec-nav-below" class="tec-nav clearfix">
			...
			<?php elseif( sp_is_upcoming() && !get_previous_posts_link( ) ) : ?>
				<a href='<?php echo sp_get_past_link(); ?>'><span><?php _e('&laquo; Previous Events', $tribe_ecp->pluginDomain ); ?></span></a>
			...
			<?php elseif( sp_is_past() && !get_previous_posts_link( ) ) : ?>
				<a href='<?php echo sp_get_upcoming_link(); ?>'><span><?php _e('Next Events &raquo;', $tribe_ecp->pluginDomain); ?></span></a>
			<?php endif; ?>
			</div>
