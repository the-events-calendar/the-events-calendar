...
?>
<h4 class="cal-header"><?php echo $tribe_ecp->monthsShort[date('M',$date)]; echo date(' Y',$date); ?> <a class="sp-view-all-events" href="<?php echo tribe_get_events_link(); ?>"><?php _e('View all &raquo;', TribeEvents::PLUGIN_DOMAIN); ?></a></h4>
