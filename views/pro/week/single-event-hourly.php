...
<div id='tribe-events-event-<?php echo $event->ID; ?>' <?php tribe_events_the_header_attributes( 'week-hourly' ); ?> class='<?php tribe_events_event_classes() ?>' data-mobile='<?php echo tribe_events_week_mobile_data( $event ); ?>'>
