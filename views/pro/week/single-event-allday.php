...
<?php else : $event = tribe_events_week_get_event(); ?>
	<div id='tribe-events-event-<?php echo $event->ID; ?>' class='<?php echo tribe_events_event_classes() ?>' <?php tribe_events_the_header_attributes( 'week-all-day' ); ?> data-mobile='<?php echo tribe_events_week_mobile_data( $event ); ?>'>
		<div>
