...
*
* You can customize this view by putting a replacement file of the same name (in-loop.php) in the events/ directory of your theme.
*/

// Don't load directly
if ( !defined('ABSPATH') ) { die('-1'); }
?>
<?php global $post, $more; $more = false; ?>
