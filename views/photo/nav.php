...
<ul class="tribe-events-sub-nav">
	...
	<li class="tribe-events-nav-previous"><a href="#" class="tribe_paged"><?php _e( '&laquo; Previous Events', 'tribe-events-calendar-pro' ) ?></a></li>
	...
	<?php endif; ?>
	>
		<a href="#" class="tribe_paged"><?php _e( 'Next Events &raquo;', 'tribe-events-calendar-pro' ) ?></a>
