...
// We have a completely different template to accommodate meta skeleton mode
if ( apply_filters( 'tribe_events_single_event_the_meta_skeleton', false, get_the_ID() ) ) {
	tribe_get_template_part( 'modules/meta/skeleton' );
	return;
}
