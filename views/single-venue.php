				...
				<div id="tec-event-meta">
					...
					<div style='margin: 0 0 10px 0;'>
						<?php echo tribe_venue_get_embedded_map(get_the_ID(), '290px', '200px') ?>
					</div>
				</div>
				<div id="tec-events-loop" class="tec-events post-list clearfix upcoming venue-events">
					<h2 class='entry-title'>Upcoming Events At This Venue</h2>
					<?php $venueEvents = sp_get_events(array('venue'=>get_the_ID())); global $post; $first = true?>
