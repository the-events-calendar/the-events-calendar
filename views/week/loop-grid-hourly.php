...
<div class="tribe-week-grid-wrapper">
	...
	<div class="tribe-grid-body clearfix">
		...
		<div class="column tribe-week-grid-hours">
			<?php for ( $hour = 0; $hour <= 23; $hour++ ) : ?>
			<div class="time-row-<?php echo date_i18n( 'gA', mktime( $hour ) ); ?>"><?php echo date_i18n( 'gA', mktime( $hour ) ); ?></div>
			<?php endfor; ?>
		...
		<div class="tribe-grid-content-wrap">
			...
			<?php /* while( tribe_events_week_have_days() ) : tribe_events_week_setup_current_day( $day_id ); */ ?>
