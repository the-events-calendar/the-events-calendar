...
class Tribe__Events__Pro__Recurrence__Queue_Realtime {
	...
	public function post_editor() {
		...
		$is_an_event = class_exists( 'TribeEvents' ) && TribeEvents::POSTTYPE === $post->post_type;
	...
	public function update_loop_vars() {
		...
		wp_localize_script( TribeEvents::POSTTYPE.'-premium-admin', 'TribeEventsProRecurrenceUpdate', $data );
	}
