...
class TribeEventsGeoLoc {
	...
	function ajax_tribe_geosearch() {
		...
		elseif ( ! $have_events && isset( $_POST['tribe_event_category'] ) ) {
			TribeEvents::setNotice( 'events-not-found', sprintf( __('No matching events listed under %s. Go view the full calendar.', 'tribe-events-calendar'), esc_html($_POST['tribe_event_category']) ) );
		}
		elseif ( ! $have_events ) {
