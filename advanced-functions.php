<?php
/**
 * The Events Calendar Advanced Functions
 *
 * Advanced functions can be used to manipulate Event, Venue and Organizer data. These functions may be useful for integration with other WordPress plugins and extended functionality.
 */
