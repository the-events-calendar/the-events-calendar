...
$support_text[] = '</li><li>';
$support_text[] = sprintf( __('%sTutorials%s written by both members of our team and users from the community, covering custom queries, integration with third-party themes and plugins, etc.', 'tribe-events-calendar'), '<a href="https://tri.be/the-events-calendar-for-wordpress-tutorials/" target="blank">', '</a>' );
$support_text[] = '</li><li>';
