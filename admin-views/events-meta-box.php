...
<div id="eventIntro">
	...
	<?php $tec->do_action( 'tribe_events_post_errors', $postId, true ) ?>

</div>
<div id='eventDetails' class="inside eventForm">
	<?php $tec->do_action( 'tribe_events_detail_top', $postId, true ) ?>
		...
		<tr>
			<td colspan="2">
				...
				<span class="timeofdayoptions">
					...
					<?php $tec->do_action( 'tribe_events_date_display', $postId, true ) ?>
				</table>
			</td>
		</tr>
	</table>
	<table id="event_venue" class="eventtable">
		...
		<?php include( $tec->pluginPath . 'admin-views/venue-meta-box.php' ); ?>
	</table>
	...
	<table id="event_organizer" class="eventtable">
		...
		<?php include( $tec->pluginPath . 'admin-views/organizer-meta-box.php' ); ?>
	</table>
	...
	<table id="event_url" class="eventtable">
		...
		<?php $tec->do_action( 'tribe_events_url_table', $postId, true ) ?>
	</table>

	<?php $tec->do_action( 'tribe_events_details_table_bottom', $postId, true ) ?>
	...
	<table id="event_cost" class="eventtable">
		...
		<?php endif; ?>
		<?php $tec->do_action( 'tribe_events_cost_table', $postId, true ) ?>
	</table>

</div>
<?php $tec->do_action( 'tribe_events_above_donate', $postId, true ) ?>
<?php $tec->do_action( 'tribe_events_details_bottom', $postId, true ) ?>
