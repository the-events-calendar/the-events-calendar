...
<p><small><em><?php printf( __( 'Want to modify the display of this widget? Try a %stemplate override%s.', 'tribe-events-calendar-pro' ), '<a href="' . TribeEvents::$tribeUrl . 'what-are-template-overrides-and-how-do-i-do-them/?utm_campaign=in-app&utm_medium=plugin-ecp&utm_source=editor">', '</a>' ); ?></em></small></p>
