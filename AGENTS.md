...
- Version placeholders in docblocks are the literal `6.17.5.1`: `@since 6.17.5.1`,
  `@deprecated 6.17.5.1`, `_deprecated_function( __METHOD__, '6.17.5.1' )`. The release
  workflow replaces them with the version being shipped. Never write a real
  version number there, and do not flag `6.17.5.1` as an unfinished placeholder.
