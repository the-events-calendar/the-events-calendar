<?php  //[STAMP] f96c9b55bcad7dd3cc2e231b4bfbc5ca
...
trait Aggregatorv1TesterActions
{
    /**
     ...
     */
    public function haveVenueInDatabase($overrides = [], $location = NULL) {
     ...
     */
    public function haveOrganizerInDatabase($overrides = []) {
     ...
     */
    public function haveManyEventsInDatabase($count, $overrides = [], $time_space = NULL) {
     ...
     */
    public function haveEventInDatabase($overrides = []) {
     ...
     * @see \Helper\TribeDb::haveManyVenuesInDatabase()
     */
    public function haveManyVenuesInDatabase($count, $overrides = []) {
     ...
     * @see \Helper\TribeDb::haveManyOrganizersInDatabase()
     */
    public function haveManyOrganizersInDatabase($count, $overrides = []) {
