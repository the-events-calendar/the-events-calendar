<?php  //[STAMP] 89fe75e69327cc7fa60d54023e7dbedd
...
trait Rewrite_functionalTesterActions
{
    /**
     ...
     * @see \Helper\Rewrite_functional::seeResponseIs()
     */
    public function seeResponseIs($expected): void {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeResponseIs', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\Rewrite_functional::seeResponseIs()
     */
    public function canSeeResponseIs($expected): void {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeResponseIs', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Rewrite_functional::update_plugin_option()
     */
    public function update_plugin_option(string $option_name, $option_value = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('update_plugin_option', func_get_args()));
    }
     ...
     * @see \Codeception\Module\WPBrowser::amOnThemesPage()
     */
     ...
     * ```
     * @see \Codeception\Module\WPBrowser::grabAvailableThemes()
     */
     ...
     * ```
     * @see \Codeception\Module\WPBrowser::grabActiveTheme()
     */
     ...
     * ```
     * @see \Codeception\Module\WPBrowser::activateTheme()
     */
     ...
     * ```
     * @see \Codeception\Module\WPBrowser::seeThemeActivated()
     */
