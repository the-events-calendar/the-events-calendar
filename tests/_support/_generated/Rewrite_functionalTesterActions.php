<?php  //[STAMP] 19757335b556d292ebf808be7bd84621
...
trait Rewrite_functionalTesterActions
{
     ...
     * @see \Helper\Rewrite_functional::have_translation_file_for_plugin()
     */
    public function have_translation_file_for_plugin(string $source_mo_file, string $dest_mo_file_relpath): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('have_translation_file_for_plugin', func_get_args()));
    }
