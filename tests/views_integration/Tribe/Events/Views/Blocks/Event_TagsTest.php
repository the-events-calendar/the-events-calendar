...
class Event_TagsTest extends HtmlTestCase {
	...
	public function test_block_is_rendered() {
		ob_start();
		echo ( new Tribe__Events__Editor__Blocks__Event_Tags() )->render();
		$block_content = ob_get_clean();

		$this->assertStringContainsString( 'tribe-events-single-section', $block_content );
		$this->assertStringContainsString( 'tribe-events-section-tags', $block_content );
	...
	public function test_render_with_single_custom_class() {
		$block_with_custom_class = new Tribe__Events__Editor__Blocks__Event_Tags();
