...
class LoaderTest extends HtmlTestCase {
	...
	public function it_should_render() {
		...
		$html = $this->template->template( 'components/loader', [ 'text' => $text ], false );
	...
	public function it_should_contain_correct_html_classes() {
		$template = $this->template->template( 'components/loader', [ 'text' => 'test' ], false );
	...
	public function it_should_escape_html_for_text() {
		...
		$template = $this->template->template( 'components/loader', [ 'text' => $text ], false );
		$html = $this->document->html( $template );
