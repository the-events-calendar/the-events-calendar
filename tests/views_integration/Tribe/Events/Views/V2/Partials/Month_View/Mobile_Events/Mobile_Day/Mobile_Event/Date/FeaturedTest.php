<?php
namespace Tribe\Events\Views\V2\Partials\Month_View\Mobile_Events\Mobile_Day\Mobile_Event\Date;
...
class FeaturedTest extends HtmlPartialTestCase
{
	...
	protected $partial_path = 'month/mobile-events/mobile-day/mobile-event/date/featured';
