...
namespace Tribe\Events\Views\V2\Partials\Month_View\Calendar_Body\Day\Multiday_Events\Multiday_Event;

use Tribe\Test\PHPUnit\Traits\With_Post_Remapping;
use Tribe\Test\Products\WPBrowser\Views\V2\HtmlPartialTestCase;

class HiddenTest extends HtmlPartialTestCase
{
	use With_Post_Remapping;

	protected $partial_path = 'month/calendar-body/day/multiday-events/multiday-event/hidden';
