<?php return '<div  class="tribe-common-g-row tribe-events-calendar-recent-past__event-row tribe-events-calendar-recent-past__event-row--featured" >

	<div class="tribe-events-calendar-recent-past__event-date-tag tribe-common-g-col">
	<time class="tribe-events-calendar-recent-past__event-date-tag-datetime" datetime="2019-06-20">
		<span class="tribe-events-calendar-recent-past__event-date-tag-month">
			Jun		</span>
		<span class="tribe-events-calendar-recent-past__event-date-tag-daynum tribe-common-h5 tribe-common-h4--min-medium">
			20		</span>
		<span class="tribe-events-calendar-recent-past__event-date-tag-year">
			2019		</span>
	</time>
</div>

	<div class="tribe-events-calendar-recent-past__event-wrapper tribe-common-g-col">
		<article  class="tribe-events-calendar-recent-past__event tribe-common-g-row tribe-common-g-row--gutters post-7 tribe_events type-tribe_events status-publish hentry" >
		...
		<span class="tribe-events-calendar-recent-past__event-datetime-featured-text tribe-common-a11y-visual-hide">
			Featured		</span>
		<time class="tribe-events-calendar-recent-past__event-datetime" datetime="2019-06-20">
