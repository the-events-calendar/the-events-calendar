...
>
	<form
		...
		role="search"
	>
		<input type="hidden" id="tribe-events-views[_wpnonce]" name="tribe-events-views[_wpnonce]" value="2ab7cc6b39" /><input type="hidden" name="_wp_http_referer" value="/page/2/?post_type=tribe_events&amp;eventDisplay=test" />		<input type="hidden" name="tribe-events-views[url]" value="http://test.tri.be/events/month/" />
