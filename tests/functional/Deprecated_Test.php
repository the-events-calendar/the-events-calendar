...
class Tribe_Deprecated_Test extends Tribe__Events__WP_UnitTestCase
{
    ...
    {
        return array(
            array('Tribe__Events__PUE__Checker', false),
            array('Tribe__Events__PUE__Utility', false),
            array('Tribe__Events__PUE__Plugin_Info', false),
        );
    }
     ...
     */
    public function test_deprecated_class_4_2($class, $in_common)
    {
