...
class EventArchiveCest extends BaseRestCest {
	 ...
	 */
	public function it_should_return_upcoming_events_if_there_are_upcoming_events( Restv1Tester $I ) {
	 ...
	 */
	public function it_should_return_a_number_of_upcoming_events_equal_to_the_posts_per_page_option_by_default( Restv1Tester $I ) {
	 ...
	 */
	public function it_should_allow_defining_the_number_of_posts_per_pages_to_return( Restv1Tester $I ) {
		$I->haveManyEventsInDatabase( 7 );
		$I->haveOptionInDatabase( 'posts_per_page', 5 );
	 ...
	 */
	public function it_should_limit_the_maximum_number_of_posts_per_pages_to_return_to_50_at_most( Restv1Tester $I ) {
	 ...
	 */
	public function it_should_return_the_identity_rest_url_for_the_root_archive_url( Restv1Tester $I ) {
		$I->haveManyEventsInDatabase( 5 );
		$I->haveOptionInDatabase( 'posts_per_page', 5 );
		...
		$I->seeResponseCodeIs( 200 );
		$I->seeResponseIsJson();
		$I->seeResponseContainsJson( [ 'rest_url' => $this->events_url . '/' ] );
	}
	 ...
	 */
	public function it_should_return_the_rest_url_to_fetch_next_events_if_there_are_more_events_than_requested( Restv1Tester $I ) {
		$I->haveManyEventsInDatabase( 7 );
		$I->haveOptionInDatabase( 'posts_per_page', 5 );
		...
		$I->seeResponseCodeIs( 200 );
		$I->seeResponseIsJson();
		$I->seeResponseContainsJson( [ 'next_rest_url' => $this->events_url . '/?page=2' ] );
	}
	 ...
	 */
	public function it_should_return_the_rest_url_to_fetch_previous_events_if_there_are_more_events_than_requested( Restv1Tester $I ) {
		...
		$I->seeResponseCodeIs( 200 );
		$I->seeResponseIsJson();
		$I->seeResponseContainsJson( [ 'previous_rest_url' => $this->events_url . '/?page=2' ] );
	}
	 ...
	 */
	public function it_should_retunr_the_archive_root_rest_url_if_previous_page_is_1( Restv1Tester $I ) {
		...
		$I->seeResponseCodeIs( 200 );
		$I->seeResponseIsJson();
		$I->seeResponseContainsJson( [ 'previous_rest_url' => $this->events_url . '/' ] );
	}
	 ...
	 */
	public function it_should_return_404_if_trying_to_fetch_non_existing_page( Restv1Tester $I ) {
	 ...
	 */
	public function it_should_allow_requesting_events_happening_after_a_date_in_the_future( Restv1Tester $I ) {
	 ...
	 */
	public function it_should_allow_requesting_events_happening_after_a_date_in_the_past( Restv1Tester $I ) {
		// 10 events each 1 week apart starting now
		$I->haveManyEventsInDatabase( 10, [], 24 * 7 );
		$I->haveOptionInDatabase( 'posts_per_page', 20 );
