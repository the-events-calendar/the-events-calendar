...
describe('addEditorTools', () => {
    ...
    it('should add editor tools', () => {
        ...
        expect(registerPlugin).toHaveBeenCalledWith('tec-editor-tools', {render: expect.any(Function)});
        ...
        expect(mockDocument.querySelector('.editor-document-tools__left .tec-editor-tool').outerHTML)
            .toMatchSnapshot();
