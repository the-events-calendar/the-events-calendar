<?php return '	<tr class="tec-events-recurrence-dates tec-events-recurrence-dates--locked">
		<td class="label">Event Dates</td>
		<td>
			<p>
				This event uses recurrence rules created with Events Calendar Pro. Activate Events Calendar Pro to edit them; the existing dates are preserved meanwhile.			</p>
		...
		<span class="tec-events-recurrence-dates__chip-group">
					...
					href="http://wordpress.test/?tribe_events=admin-snapshot-locked-event&#038;eventDate=2050-01-03"
					target="_blank"
		...
		<span class="tec-events-recurrence-dates__chip-group">
					...
					href="http://wordpress.test/?tribe_events=admin-snapshot-locked-event&#038;eventDate=2050-01-10"
					target="_blank"
					rel="noreferrer noopener"
