<?php return '	<tr class="tec-events-recurrence-dates tec-events-recurrence-dates--locked tec-events-recurrence-dates--lock-enabled tec-events-recurrence-dates--occurrence">
		...
		<td>
						<div class="notice notice-info inline tec-events-recurrence-dates__lock-notice">
									<p id="tec-events-recurrence-dates-lock-reason">
													This is one date of an event that uses recurrence rules created with Events Calendar Pro. Its start and end dates are locked.											</p>
					<p>
