...
class Event_PriceTest extends \Codeception\TestCase\WPTestCase {
	private $template;
	...
	/**
	 * @return Tribe__Events__Editor__Blocks__Event_Price
	 */
	private function make_instance() {
		return new Tribe__Events__Editor__Blocks__Event_Price();
	}
