...
class Event_VenueTest extends \Codeception\TestCase\WPTestCase {
	private $template;
	...
	/**
	 * @return Tribe__Events__Editor__Blocks__Event_Venue
	 */
	private function make_instance() {
		return new Tribe__Events__Editor__Blocks__Event_Venue();
	}
