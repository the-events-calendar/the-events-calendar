...
class Event_DatetimeTest extends \Codeception\TestCase\WPTestCase {
	private $template;
	...
	/**
	 * @return Tribe__Events__Editor__Blocks__Event_Datetime
	 */
	private function make_instance() {
		return new Tribe__Events__Editor__Blocks__Event_Datetime();
	}
