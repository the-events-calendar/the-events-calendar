...
class Event_OrganizerTest extends \Codeception\TestCase\WPTestCase {
	private $template;
	...
	/**
	 * @return Tribe__Events__Editor__Blocks__Event_Organizer
	 */
	private function make_instance() {
		return new Tribe__Events__Editor__Blocks__Event_Organizer();
	}
