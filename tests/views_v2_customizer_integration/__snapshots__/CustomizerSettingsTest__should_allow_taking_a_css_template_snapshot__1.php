<?php return array (
  'tribe-events-views-v2-full' => ':root {
...
--tec-color-background-secondary-multiday-hover: rgba(35,137,35, 0.34);
				...
				--tec-color-background-events-bar-submit-button: #238923;
--tec-color-background-events-bar-submit-button-hover: rgba(35,137,35,0.8);
--tec-color-background-events-bar-submit-button-active: rgba(35,137,35,0.9);
			}',
);
