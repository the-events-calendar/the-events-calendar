...
function tribe_test_tab() {
	$testTabArgs = array(
		'fields' => array(
			...
			'text_test_small' => array( 'type' => 'text', 'label' => 'This is a small text field', 'size' => 'small', 'validation_type' => 'positive_int', 'parent_option' => 'EventOptions'),
			...
			'checkbox_text' => array( 'type' => 'checkbox_bool', 'label' => 'This is a checkbox field', 'parent_option' => 'EventOptions'),
