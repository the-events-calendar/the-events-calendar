...
Scenario Outline: Keyword search in Month View with results
	Given that I am on Month View
	And "Month view events per day" is set to <month view events per day>
	...
	And days with more than <month view events per day> matching events should display only <month view events per day> events and a "View All" link to Day View

	Examples:
        | month view events per day | cabbage events    | events displayed 	|
        |    3 [default]		    |   5			    |  3 			    |
        |    5				        |   5			    |  5			    |
        |    5				        |   10			    |  5 			    |
        |    10				        |   10			    |  10 			    |
