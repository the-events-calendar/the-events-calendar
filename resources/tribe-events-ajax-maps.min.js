...
a.title,a.address,a.link)}),f.pushstate&&(a.do_string&&history.pushState({tribe_paged:a.paged,tribe_params:a.params},"",k.cur_url+"?"+a.params),a.pushstate&&history.pushState({tribe_paged:a.paged,tribe_params:a.params},"",k.cur_url)),b(h).trigger("tribe_ev_ajaxSuccess").trigger("tribe_ev_mapView_AjaxSuccess"),0<c.markers.length&&r())})}function u(c){"change_view"!=tribe_events_bar_action&&(c.preventDefault(),a.ajax_running||(a.paged=1,a.view="map",a.popping=!1,f.pushstate?d.pre_ajax(function(){g(null)}):
d.pre_ajax(function(){b(h).trigger("tribe_ev_reloadOldBrowser")})))}function q(){if(c.markers){for(i in c.markers)c.markers[i].setMap(null);c.markers.length=0;c.bounds=new google.maps.LatLngBounds}}function r(){c.map.fitBounds(c.bounds);13<c.map.getZoom()&&c.map.setZoom(13)}function l(){b("#tribe-events-footer, #tribe-events-header").find(".tribe-events-ajax-loading").show()}function s(){b("#tribe-events-footer, #tribe-events-header").find(".tribe-events-ajax-loading").hide()}m();var e={zoom:5,center:new google.maps.LatLng(GeoLoc.center.max_lat,
...
e;b("body").addClass("events-list");d.tooltips()}f.map_view()&&k.params?(e=k.params,0<=d.in_params(e,"tribe_geosearch")||(e+="&action=tribe_geosearch"),0<=d.in_params(e,"tribe_paged")||(e+="&tribe_paged=1"),a.params=e,a.do_string=!1,a.pushstate=!1,a.popping=!0,d.pre_ajax(function(){g(null)})):f.map_view()&&(a.do_string=!1,a.pushstate=!1,a.popping=!1,a.initial_load=!0,d.pre_ajax(function(){g(null)}));f.pushstate&&f.map_view()&&(history.replaceState({tribe_paged:a.paged,tribe_params:a.params},"",location.href),
b(window).on("popstate",function(b){if(b=b.originalEvent.state)a.do_string=!1,a.pushstate=!1,a.popping=!0,a.params=b.tribe_params,a.paged=b.tribe_paged,d.pre_ajax(function(){g(null)}),d.set_form(a.params)}));f.map_view()&&(b("#tribe-geo-options").on("click","a",function(a){l();a.preventDefault();b("#tribe-geo-options a").removeClass("tribe-option-loaded");b(this).addClass("tribe-option-loaded");b("#tribe-bar-geoloc").val(b(this).text());b("#tribe-bar-geoloc-lat").val(c.geocodes[b(this).attr("data-index")].geometry.location.lat());
b("#tribe-bar-geoloc-lng").val(c.geocodes[b(this).attr("data-index")].geometry.location.lng());f.pushstate?d.pre_ajax(function(){g(null);b("#tribe-geo-options").hide()}):d.pre_ajax(function(){b(h).trigger("tribe_ev_reloadOldBrowser")})}),d.snap("#tribe-events-content-wrapper","#tribe-events-content-wrapper","#tribe-events-footer .tribe-events-nav-previous a, #tribe-events-footer .tribe-events-nav-next a"));b(h).on("tribe_ev_reloadOldBrowser",function(){p();window.location=k.cur_url+"?"+a.params});
if(f.map_view()){var t;b("#tribe-geo-map-wrapper").resize(function(){t=c.map.getCenter();google.maps.event.trigger(c.map,"resize");c.map.setCenter(t)});b("#tribe-events").on("click","li.tribe-events-nav-next a",function(c){c.preventDefault();a.ajax_running||("past"===a.view?1===a.paged?a.view="map":a.paged--:a.paged++,a.popping=!1,f.pushstate?d.pre_ajax(function(){g(null)}):d.pre_ajax(function(){b(h).trigger("tribe_ev_reloadOldBrowser")}))}).on("click","li.tribe-events-nav-previous a",function(c){c.preventDefault();
...
1;l();b(".tribe-events-sub-nav").remove();var e=b("#tribe-bar-geoloc").val();return""!==e?(q(),b("#tribe-geo-results").empty(),b("#tribe-geo-options").hide(),b("#tribe-geo-options #tribe-geo-links").empty(),d.process_geocoding(e,function(a){c.geocodes=a;s();var e=a[0].geometry.location.lat();a=a[0].geometry.location.lng();e&&b("#tribe-bar-geoloc-lat").val(e);a&&b("#tribe-bar-geoloc-lng").val(a);1<c.geocodes.length?(d.print_geo_options(),m(),r()):f.pushstate?(m(),g(c.geocodes[0])):b(h).trigger("tribe_ev_reloadOldBrowser")}),
!1):""===e?(b("#tribe-bar-geoloc-lat").val(""),b("#tribe-bar-geoloc-lng").val(""),b("#tribe-geo-options").hide(),f.pushstate?(m(),g(null)):b(h).trigger("tribe_ev_reloadOldBrowser"),s(),!1):!0}}),a.view&&n&&debug.timeEnd("Tribe JS Init Timer"));n&&debug.info("tribe-events-ajax-maps.js successfully loaded")})})(jQuery,tribe_ev.data,tribe_ev.events,tribe_ev.fn,tribe_ev.geoloc,tribe_ev.state,tribe_ev.tests,tribe_debug);
