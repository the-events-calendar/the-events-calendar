...
50},500);k()})});a(".ticket_delete").live("click",function(b){b.preventDefault();h();b={action:"tribe-ticket-delete-"+a(this).attr("attr-provider"),post_ID:a("#post_ID").val(),ticket_id:a(this).attr("attr-ticket-id"),nonce:TribeTickets.remove_ticket_nonce};a.post(ajaxurl,b,function(b){b.success&&(g(),a("td.ticket_list_container").empty().html(b.data))},"json").complete(function(){k()})});a(".ticket_edit").live("click",function(b){b.preventDefault();a("h4.ticket_form_title_edit").show();a("h4.ticket_form_title_add").hide();
h();b={action:"tribe-ticket-edit-"+a(this).attr("attr-provider"),post_ID:a("#post_ID").val(),ticket_id:a(this).attr("attr-ticket-id"),nonce:TribeTickets.edit_ticket_nonce};a.post(ajaxurl,b,function(b){g();a("#ticket_id").val(b.data.ID);a("#ticket_name").val(b.data.name);a("#ticket_description").val(b.data.description);a("#ticket_price").val(b.data.price);a("#ticket_start_date").val(b.data.start_date.substring(0,10));a("#ticket_end_date").val(b.data.end_date.substring(0,10));if(b.data.start_date){var c=
b.data.start_date.substring(11,13),e="am";12<parseInt(c)&&(e="pm",c=parseInt(c)-12,c=("0"+c).slice(-2));12===parseInt(c)&&(e="pm");a("#ticket_start_hour").val(c);a("#ticket_start_meridian").val(e)}b.data.end_date&&(c=b.data.end_date.substring(11,13),e="am",12<parseInt(c)&&(e="pm",c=parseInt(c)-12,c=("0"+c).slice(-2)),12===parseInt(c)&&(e="pm"),a("#ticket_end_hour").val(c),a("#ticket_end_meridian").val(e),a("#ticket_start_minute").val(b.data.start_date.substring(14,16)),a("#ticket_end_minute").val(b.data.end_date.substring(14,
16)));a("tr.ticket_advanced_"+b.data.provider_class).remove();a("tr.ticket.bottom").before(b.data.advanced_fields);a("input:radio[name=ticket_provider]").filter("[value="+b.data.provider_class+"]").click();a("a#ticket_form_toggle").hide();a("#ticket_form").show()},"json").complete(function(){a("html, body").animate({scrollTop:a("#ticket_form_table").offset().top-50},500);k()})});ticketHeaderImage={uploader:function(){var a=wp.media({title:HeaderImageData.title,multiple:!1,library:{type:"image"},button:{text:HeaderImageData.button}});
a.on("close",function(){var d=a.state().get("selection").toJSON();d.length&&ticketHeaderImage.render(d[0])});a.open();return!1},render:function(b){a("#tribe_ticket_header_preview").html(ticketHeaderImage.imgHTML(b));a("#tribe_ticket_header_image_id").val(b.id);a("#tribe_ticket_header_remove").show()},imgHTML:function(a){var d='<img src="'+a.url+'" ',d=d+('width="'+a.width+'" '),d=d+('height="'+a.height+'" ');return d+"/>"}};var l=a("#tribe_ticket_header_remove"),m=a("#tribe_ticket_header_preview");
m.find("img").length&&l.show();l.live("click",function(b){b.preventDefault();m.html("");l.hide();a("#tribe_ticket_header_image_id").val("")});a("#tribe_ticket_header_preview img").length&&(f=a("#tribe_ticket_header_preview img"),f.removeAttr("width").removeAttr("height"),a("#tribetickets").width()<f.width()&&f.css("width","95%"))});
