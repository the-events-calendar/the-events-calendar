...
function p(){b("#tribe-events-header");b(".tribe-events-grid").tribe_spin();a.pushcount=0;a.ajax_running=!0;if(!a.popping&&(a.filter_cats&&(d.cur_url=d.base_url),a.params={action:"tribe_week",eventDate:a.date},a.url_params={},a.category&&(a.params.tribe_event_category=a.category),b(h).trigger("tribe_ev_serializeBar"),a.params=b.param(a.params),a.url_params=b.param(a.url_params),b(h).trigger("tribe_ev_collectParams"),a.pushstate=!0,a.do_string=!1,0<a.pushcount||a.filters))a.pushstate=!1,a.do_string=
!0;g.pushstate?(m&&debug.time("Week View Ajax Timer"),b(h).trigger("tribe_ev_ajaxStart").trigger("tribe_ev_weekView_AjaxStart"),b.post(TribeWeek.ajaxurl,a.params,function(c){a.initial_load=!1;e.enable_inputs("#tribe_events_filters_form","input, select");c.success&&(a.ajax_running=!1,d.ajax_response={total_count:"",view:c.view,max_pages:"",tribe_paged:"",timestamp:(new Date).getTime()},b("#tribe-events-content.tribe-events-week-grid").replaceWith(c.html),n(s(),!1),b(".tribe-events-grid").resize(function(){n(!1,
!0)}),b("div[id*='tribe-events-event-']").hide().fadeIn("fast"),a.page_title=b("#tribe-events-header").data("title"),r.title=a.page_title,a.do_string&&history.pushState({tribe_url_params:a.url_params,tribe_params:a.params},a.page_title,d.cur_url+"?"+a.url_params),a.pushstate&&history.pushState({tribe_url_params:a.url_params,tribe_params:a.params},a.page_title,d.cur_url),b(h).trigger("tribe_ev_ajaxSuccess").trigger("tribe_ev_weekView_AjaxSuccess"),m&&debug.timeEnd("Week View Ajax Timer"))})):q.location=
a.do_string?d.cur_url+"?"+a.url_params:d.cur_url}var z=b("#tribe-events"),l=b("#tribe-events-bar"),u=b("#tribe-events-header");l.addClass("tribe-has-datepicker");a.date=u.data("date");var A=b("#tribe-bar-date").bootstrapDatepicker({format:"yyyy-mm-dd",showAnim:"fadeIn",onRender:function(a){var d=u.data("startofweek"),e=[0,1,2,3,4,5,6];delete e[d];a=a.getDay();for(i=0;i<e.length;i++)if(-1!=b.inArray(a,e))return"disabled";return""}}).on("changeDate",function(){A.hide()}).data("datepicker");n(s(),!1);
b(".tribe-events-grid").resize(function(){n(!1,!0)});g.pushstate&&!g.map_view()&&(l="action=tribe_week&eventDate="+a.date,d.params.length&&(l=l+"&"+d.params),history.replaceState({tribe_params:l,tribe_url_params:d.params},"",location.href),b(q).on("popstate",function(b){if(b=b.originalEvent.state)a.do_string=!1,a.pushstate=!1,a.popping=!0,a.params=b.tribe_params,a.url_params=b.tribe_url_params,e.pre_ajax(function(){p()}),e.set_form(a.params)}));z.on("click",".tribe-events-sub-nav a",function(c){c.preventDefault();
a.ajax_running||(c=b(this),a.popping=!1,a.date=c.attr("data-week"),d.cur_url=c.attr("href"),e.update_picker(a.date),e.pre_ajax(function(){p()}))});b("form#tribe-bar-form").on("submit",function(a){t(a)});if(g.live_ajax()&&g.pushstate)b("#tribe-bar-date").on("changeDate",function(a){g.reset_on()||t(a)});e.snap("#tribe-events-content","body","#tribe-events-footer .tribe-events-nav-previous a, #tribe-events-footer .tribe-events-nav-next a");b(h).on("tribe_ev_runAjax",function(){p()});m&&debug.info("TEC Debug: tribe-events-week.js successfully loaded");
a.view&&m&&debug.timeEnd("Tribe JS Init Timer")})})(window,document,jQuery,tribe_ev.data,tribe_ev.events,tribe_ev.fn,tribe_ev.state,tribe_ev.tests,tribe_debug);
