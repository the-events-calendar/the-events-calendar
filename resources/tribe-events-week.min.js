...
l=b("#tribe-events-bar"),u=b("#tribe-events-header");l.addClass("tribe-has-datepicker");a.date=u.data("date");var A=b("#tribe-bar-date").bootstrapDatepicker({format:"yyyy-mm-dd",showAnim:"fadeIn",onRender:function(a){var d=u.data("startofweek"),e=[0,1,2,3,4,5,6];delete e[d];a=a.getDay();for(i=0;i<e.length;i++)if(-1!=b.inArray(a,e))return"disabled";return""}}).on("changeDate",function(){A.hide()}).data("datepicker");n(s(),!1);b(".tribe-events-grid").resize(function(){n(!1,!0)});g.pushstate&&!g.map_view()&&
(l="action=tribe_week&eventDate="+a.date,d.params.length&&(l=l+"&"+d.params),history.replaceState({tribe_params:l,tribe_url_params:d.params},"",location.href),b(q).on("popstate",function(b){if(b=b.originalEvent.state)a.do_string=!1,a.pushstate=!1,a.popping=!0,a.params=b.tribe_params,a.url_params=b.tribe_url_params,e.pre_ajax(function(){p()}),e.set_form(a.params)}));z.on("click",".tribe-events-sub-nav a",function(c){c.preventDefault();a.ajax_running||(c=b(this),a.popping=!1,a.date=c.attr("data-week"),
