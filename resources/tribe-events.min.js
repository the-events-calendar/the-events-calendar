...
e.prop("checked",!0):b('select[name="'+d+'"] option[value="'+c[f]+'"]').attr("selected",!0)}});e&&debug.info('TEC Debug: tribe_ev.fn.set_form fired these params: "'+a);c.removeClass("tribe-reset-on")},setup_ajax_timer:function(a){clearTimeout(tribe_ev.state.ajax_timer);tribe_ev.tests.reset_on()||(tribe_ev.state.ajax_timer=setTimeout(function(){a()},500),e&&debug.info('TEC Debug: tribe_ev.fn.setup_ajax_timer fired with a timeout of "500" ms'))},snap:function(a,c,d){b(c).on("click",d,function(c){c.preventDefault();
