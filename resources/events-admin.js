jQuery(document).ready(function($) {
  ...
  $('#doaction, #doaction2').click(function(e){
	...
	function updateRecurrenceText() {
		...
		if ( rec_custom_type == 'Daily' ) { if ( rec_custom_interval > 1 ) { rec_custom_interval_text = 'days' } else { rec_custom_interval_text = 'day' } }
		if ( rec_custom_type == 'Weekly' ) { if ( rec_custom_interval > 1 ) { rec_custom_interval_text = 'weeks' } else { rec_custom_interval_text = 'week' } }
		if ( rec_custom_type == 'Monthly' ) { if ( rec_custom_interval > 1 ) { rec_custom_interval_text = 'months' } else { rec_custom_interval_text = 'month' } }
		if ( rec_custom_type == 'Yearly' ) { if ( rec_custom_interval > 1 ) { rec_custom_interval_text = 'years' } else { rec_custom_interval_text = 'year' } }
