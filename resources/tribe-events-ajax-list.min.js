(function(b,d,h,e,a,f){b(document).ready(function(){function l(b){"change_view"!=tribe_events_bar_action&&(b.preventDefault(),a.ajax_running||(a.paged=1,a.view="list",a.popping=!1,e.pre_ajax(function(){k()})))}function k(){b("#tribe-events-header").tribe_spin();a.ajax_running=!0;if(!a.popping){a.filter_cats&&(d.cur_url=b("#tribe-events-header").attr("data-baseurl"));var c=b("#tribe-events-list-hash").val();a.params={action:"tribe_list",tribe_paged:a.paged,tribe_event_display:a.view};a.url_params=
