...
"#tribe-events-footer .tribe-events-nav-previous a, #tribe-events-footer .tribe-events-nav-next a");if(f.live_ajax()&&f.pushstate)b("#tribe-events-bar").on("changeDate","#tribe-bar-date",function(b){f.reset_on()||(a.popping=!1,p(b))});b("form#tribe-bar-form").on("submit",function(b){a.popping=!1;p(b)});b(h).on("tribe_ev_runAjax",function(){k()});l&&debug.info("TEC Debug: tribe-events-ajax-list.js successfully loaded");a.view&&l&&debug.timeEnd("Tribe JS Init Timer")})})(window,document,jQuery,tribe_ev.data,
