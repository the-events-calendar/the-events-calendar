(function(n,m,b,d,f,e,a,g,h){h&&(b().isotope||debug.warn("TEC Debug: vendor bootstrapDatepicker was not loaded before its dependant file tribe-photo-view.js"));b(m).ready(function(){function m(){b(".photo-loader").hide();b("#tribe-events-photo-events").removeClass("photo-hidden").animate({opacity:"1"},{duration:600})}function p(a){q=a.width();645>q?a.addClass("photo-two-col"):a.removeClass("photo-two-col")}function r(a){b().isotope?(a.imagesLoaded(function(){a.isotope({transformsEnabled:!1,containerStyle:{position:"relative",
overflow:"visible"}},m());h&&debug.info("TEC Debug: imagesLoaded setup isotope on photo view.")}),p(a),a.resize(function(){p(a);clearTimeout(s);s=setTimeout(function(){a.isotope("reLayout")},400)})):b("#tribe-events-photo-events").removeClass("photo-hidden").css("opacity","1")}function t(b){"change_view"!=tribe_events_bar_action&&(b.preventDefault(),a.ajax_running||(a.paged=1,a.view="photo",a.popping=!1,e.pre_ajax(function(){l()})))}function l(){b("#tribe-events-header").tribe_spin();b(".photo-loader").show();
...
tribe_url_params:a.url_params},"",d.cur_url+"?"+a.url_params),a.pushstate&&history.pushState({tribe_params:a.params,tribe_url_params:a.url_params},"",d.cur_url),r(b("#tribe-events-photo-events")),b(f).trigger("tribe_ev_ajaxSuccess").trigger("tribe_ev_photoView_AjaxSuccess"),h&&debug.timeEnd("Photo View Ajax Timer"))})):n.location=a.do_string?d.cur_url+"?"+a.url_params:d.cur_url}var k=e.get_url_param("tribe_paged"),u=b("#tribe-events-photo-events"),q=0,s;a.view="photo";k&&(a.paged=k);r(u);g.pushstate&&
!g.map_view()&&(k="action=tribe_photo&tribe_paged="+a.paged,d.params.length&&(k=k+"&"+d.params),history.replaceState({tribe_params:k,tribe_url_params:d.params},"",location.href),b(n).on("popstate",function(b){if(b=b.originalEvent.state)a.do_string=!1,a.pushstate=!1,a.popping=!0,a.params=b.tribe_params,a.url_params=b.tribe_url_params,e.pre_ajax(function(){l()}),e.set_form(a.params)}));b("#tribe-events").on("click","li.tribe-events-nav-next a",function(b){b.preventDefault();a.ajax_running||("past"===
a.view?1===a.paged?a.view="photo":a.paged--:a.paged++,a.popping=!1,e.pre_ajax(function(){l()}))}).on("click","li.tribe-events-nav-previous a",function(b){b.preventDefault();a.ajax_running||("photo"===a.view?1===a.paged?a.view="past":a.paged--:a.paged++,a.popping=!1,e.pre_ajax(function(){l()}))});if(g.live_ajax()&&g.pushstate)b("#tribe-bar-date").on("changeDate",function(a){g.reset_on()||t(a)});b(f).on("tribe_ev_updatingRecurrence",function(){a.popping=!1});b("#tribe-bar-form").on("submit",function(a){"change_view"!=
tribe_events_bar_action&&t(a)});e.snap("#tribe-events-content","#tribe-events-content","#tribe-events-footer .tribe-events-nav-previous a, #tribe-events-footer .tribe-events-nav-next a");b(f).on("tribe_ev_runAjax",function(){l()});h&&debug.info("TEC Debug: tribe-events-photo-view.js successfully loaded");a.view&&h&&debug.timeEnd("Tribe JS Init Timer")})})(window,document,jQuery,tribe_ev.data,tribe_ev.events,tribe_ev.fn,tribe_ev.state,tribe_ev.tests,tribe_debug);
