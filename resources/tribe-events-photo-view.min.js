...
overflow:"visible"}},s());h&&debug.info("TEC Debug: imagesLoaded setup isotope on photo view.")}),m(a),a.resize(function(){m(a);clearTimeout(q);q=setTimeout(function(){a.isotope("reLayout")},400)})):b("#tribe-events-photo-events").removeClass("photo-hidden").css("opacity","1")}function r(b){"change_view"!=tribe_events_bar_action&&(b.preventDefault(),a.ajax_running||(a.paged=1,a.popping=!1,e.pre_ajax(function(){l()})))}function l(){b("#tribe-events-content").tribe_spin();b(".photo-loader").show();
