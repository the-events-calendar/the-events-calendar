...
0===c.total_count&&b("#tribe-events-header .tribe-events-sub-nav").empty(),b(".tribe-events-promo").next(".tribe-events-promo").remove(),b("#tribe-events-content").next(".tribe-clear").remove(),c=b("#tribe-events-header").attr("data-title"),b(document).attr("title",c),a.do_string&&(d.cur_url=d.cur_url+"?"+a.url_params,history.pushState({tribe_date:a.date,tribe_params:a.params},c,d.cur_url)),a.pushstate&&history.pushState({tribe_date:a.date,tribe_params:a.params},c,d.cur_url),n(),b(f).trigger("tribe_ev_ajaxSuccess").trigger("tribe_ev_dayView_AjaxSuccess"),
