...
c+tribe_ev.state.date+"/"):(tribe_ev.state.date=tribe_ev.data.cur_date,tribe_ev.data.cur_url=c+tribe_ev.data.cur_date+"/"),tribe_ev.fn.pre_ajax(function(){d()})))}function d(){tribe_ev.state.pushcount=0;tribe_ev.state.ajax_running=!0;if(!tribe_ev.state.popping&&(tribe_ev.state.url_params="",tribe_ev.state.params={action:"tribe_event_day",eventDate:tribe_ev.state.date},tribe_ev.state.url_params={action:"tribe_event_day"},tribe_ev.state.category&&(tribe_ev.state.params.tribe_event_category=tribe_ev.state.category),
a(tribe_ev.events).trigger("tribe_ev_serializeBar"),tribe_ev.state.params=a.param(tribe_ev.state.params),tribe_ev.state.url_params=a.param(tribe_ev.state.url_params),a(tribe_ev.events).trigger("tribe_ev_collectParams"),tribe_ev.state.pushstate=!0,tribe_ev.state.do_string=!1,0<tribe_ev.state.pushcount||tribe_ev.state.filters))tribe_ev.state.pushstate=!1,tribe_ev.state.do_string=!0;tribe_ev.tests.pushstate&&!tribe_ev.state.filter_cats?(a(tribe_ev.events).trigger("tribe_ev_ajaxStart").trigger("tribe_ev_dayView_AjaxStart"),
