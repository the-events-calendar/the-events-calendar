...
d.val(a.text());b("#tribe-bar-geoloc-lat").val(e.geocodes[a.attr("data-index")].geometry.location.lat());b("#tribe-bar-geoloc-lng").val(e.geocodes[a.attr("data-index")].geometry.location.lng());g.pre_ajax(function(){b(k).trigger("tribe_ev_runAjax");h.hide()})}),b("body").on("click",function(a){h.hide()})),g.snap("#tribe-geo-wrapper","#tribe-geo-wrapper","#tribe-events-footer .tribe-events-nav-previous a, #tribe-events-footer .tribe-events-nav-next a"));q&&debug.info("TEC Debug: tribe-events-pro.js successfully loaded")})})(window,
