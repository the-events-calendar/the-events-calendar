...
function(a,b){if(b==google.maps.GeocoderStatus.OK)return c(a),a;b==google.maps.GeocoderStatus.ZERO_RESULTS&&GeoLoc.map_view&&spin_end();return b})},set_recurrence:function(a){a?(tribe_ev.state.recurrence=!0,tribe_storage&&tribe_storage.setItem("tribeHideRecurrence","1")):(tribe_ev.state.recurrence=!1,tribe_storage&&tribe_storage.setItem("tribeHideRecurrence","0"))}});a.extend(tribe_ev.tests,{hide_recurrence:function(){return a("#tribeHideRecurrence:checked").length?!0:!1}});tribe_ev.geoloc={map:[],
geocoder:[],geocodes:[],bounds:[],markers:[]}})(jQuery);
