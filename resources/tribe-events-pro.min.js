...
tribe_storage.setItem("tribeHideRecurrence","1")):(e.recurrence=!1,tribe_storage&&tribe_storage.setItem("tribeHideRecurrence","0"))}});a.extend(tribe_ev.tests,{hide_recurrence:function(){return a("#tribeHideRecurrence:checked").length?!0:!1}});a(n).ready(function(){function b(){var b=n.URL,c="?";0<b.indexOf("?")&&(c="&");b=b+c+"ical=1&tribe_display="+e.view;a("a.tribe-events-ical").attr("href",b)}a(".tribe-bar-geoloc-filter").length&&a(".tribe-bar-geoloc-filter").append('<div id="tribe-geo-options"><div id="tribe-geo-links"></div></div>');
var c=a("#tribe-events"),d=a("#tribe-bar-geoloc"),h=a("#tribe-geo-options"),p=!1;g.pro_tooltips();m.hide_recurrence()&&g.set_recurrence(!0);a(k).on("tribe_ev_ajaxSuccess",function(){b()});b();e.recurrence=m.hide_recurrence();c.on("click","#tribeHideRecurrence",function(){e.popping=!1;e.do_string=!0;e.paged=1;p=a(this).is(":checked")?!0:!1;g.set_recurrence(p);a(k).trigger("tribe_ev_updatingRecurrence").trigger("tribe_ev_runAjax")});a(k).on("tribe_ev_preCollectBarParams",function(){d.length&&(d.val().length?
