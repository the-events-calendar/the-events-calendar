...
* Tweak - New action `tribe_events_ical_before` was added to allow flexibility in the setup of filters before the feed is created.  [86227]
* Tweak - New filters `tribe_events_ical_events_list_args` and `tribe_events_ical_events_list_query` was added to allow a custom construction of Events objects to populate the iCal feed [86227]
