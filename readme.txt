...
* Fix - Fix a redirection issues that was interfering with other plugins redirections; props to the "Nextend Social Login and Register" devs for the heads-up [BTRIA-271]
