...
* Tweak - TODO [44556*]
* Tweak - Improve the 'stickiness' of CSV import column mappings (props: @jamesgol) [45676]
* Tweak - Consistency of JSON-LD markup improved (props: @garrettjohnson) [44700]
* Tweak - Avoid notice-level errors when working with WP CLI on a site where The Events Calendar is also active (props: @sun) [45601]
