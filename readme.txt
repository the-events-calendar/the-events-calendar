...
* Tweak - Remove Eventbrite dependency on Aggregator Admin view. [EA-133]
...
* Hook - New filter to overwrite the location of an admin eventbrite file using only the location of the file name `tribe_aggregator_template_file/{$file_name}`. [EA-133]
