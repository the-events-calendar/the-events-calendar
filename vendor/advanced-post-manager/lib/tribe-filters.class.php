...
class Tribe_Filters {
	...
	public function enqueue() {
		...
		if ( $current_screen->id == 'edit-' . $this->filtered_post_type ) {
			...
			wp_enqueue_script('tribe-filters', $resources_url . 'tribe-filters.js', array('jquery-ui-sortable', 'tribe-jquery-ui-datepicker'), apply_filters( 'tribe_events_pro_js_version', Tribe__Events__Pro__Main::VERSION ), true );
		}
	}
